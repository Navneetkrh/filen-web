import { H as J, a as rt, s as at, b as lt, c as ot, n as ct, o as ht, l as et, g as it, a7 as ut, A as yt, T as ft, e as pt, i as gt, q as dt, P as mt } from "./index.Dfumm3oK.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import { a as tt } from "./arc.Budyuigr.1760966607190.js";
import { o as _t } from "./ordinal.DNLwDuR1.1760966607190.js";
import { a as xt } from "./array.BKyUJesY.1760966607190.js";
import { c as F } from "./path.CbwjOpE9.1760966607190.js";
...
function bt() {
  ...
  function y(a) {
    ...
    for (l = 0; l < d; ++l) (t = v[m[l] = l] = +e(a[l], l, a)) > 0 && (T += t);
    for (u != null ? m.sort(function(i, n) {
      return u(v[i], v[n]);
    }) : $ != null && m.sort(function(i, n) {
      return $(a[i], a[n]);
    }), l = 0, I = T ? (E - d * b) / T : 0; l < d; ++l, c = O) k = m[l], t = v[k], O = c + (t > 0 ? t * I : 0) + b, v[k] = { data: a[k], index: l, value: t, startAngle: c, endAngle: O, padAngle: w };
    return v;
  }
...
var K = function() {
  var e = function(b, t, i, n) {
    ...
    return i;
  }, u = [1, 3], $ = [1, 4], p = [1, 5], g = [1, 6], A = [1, 10, 12, 14, 16, 18, 19, 20, 21, 22], y = [2, 4], a = [1, 5, 10, 12, 14, 16, 18, 19, 20, 21, 22], l = [20, 21, 22], d = [2, 7], k = [1, 12], I = [1, 13], T = [1, 14], m = [1, 15], v = [1, 16], c = [1, 17], E = { trace: function() {
  }, yy: {}, symbols_: { error: 2, start: 3, eol: 4, PIE: 5, document: 6, showData: 7, line: 8, statement: 9, txt: 10, value: 11, title: 12, title_value: 13, acc_title: 14, acc_title_value: 15, acc_descr: 16, acc_descr_value: 17, acc_descr_multiline_value: 18, section: 19, NEWLINE: 20, ";": 21, EOF: 22, $accept: 0, $end: 1 }, terminals_: { 2: "error", 5: "PIE", 7: "showData", 10: "txt", 11: "value", 12: "title", 13: "title_value", 14: "acc_title", 15: "acc_title_value", 16: "acc_descr", 17: "acc_descr_value", 18: "acc_descr_multiline_value", 19: "section", 20: "NEWLINE", 21: ";", 22: "EOF" }, productions_: [0, [3, 2], [3, 2], [3, 3], [6, 0], [6, 2], [8, 2], [9, 0], [9, 2], [9, 2], [9, 2], [9, 2], [9, 1], [9, 1], [4, 1], [4, 1], [4, 1]], performAction: function(t, i, n, r, o, s, P) {
    var _ = s.length - 1;
    switch (o) {
      case 3:
        r.setShowData(true);
...
` + h.showPosition() + `
Expecting ` + W.join(", ") + ", got '" + (this.terminals_[x] || x) + "'" : Z = "Parse error on line " + (f + 1) + ": Unexpected " + (x == M ? "end of input" : "'" + (this.terminals_[x] || x) + "'"), this.parseError(Z, { text: h.match, token: this.terminals_[x] || x, line: h.yylineno, loc: q, expected: W });
      }
      if (S[0] instanceof Array && S.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + L + ", token: " + x);
      switch (S[0]) {
        case 1:
          n.push(x), o.push(h.yytext), s.push(h.yylloc), n.push(S[1]), x = null, V = h.yyleng, _ = h.yytext, f = h.yylineno, q = h.yylloc;
          break;
        case 2:
          if (D = this.productions_[S[1]][1], z.$ = o[o.length - D], z._$ = { first_line: s[s.length - (D || 1)].first_line, last_line: s[s.length - 1].last_line, first_column: s[s.length - (D || 1)].first_column, last_column: s[s.length - 1].last_column }, nt && (z._$.range = [s[s.length - (D || 1)].range[0], s[s.length - 1].range[1]]), H = this.performAction.apply(z, [_, V, f, N.yy, S[1], o, s].concat(B)), typeof H < "u") return H;
    ...
    var b = { EOF: 1, parseError: function(i, n) {
...
` + i + "^";
      ...
      var n, r, o;
      if (this.options.backtrack_lexer && (o = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (o.yylloc.range = this.yylloc.range.slice(0))), r = t[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: r ? r[r.length - 1].length - r[r.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + t[0].length }, this.yytext += t[0], this.match += t[0], this.matches = t, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(t[0].length), this.matched += t[0], n = this.performAction.call(this, this.yy, this, i, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), n) return n;
      if (this._backtrack) {
      ...
      for (var o = this._currentRules(), s = 0; s < o.length; s++) if (n = this._input.match(this.rules[o[s]]), n && (!i || n[0].length > i[0].length)) {
        if (i = n, r = s, this.options.backtrack_lexer) {
          if (t = this.test_match(n, o[s]), t !== false) return t;
          if (this._backtrack) {
            i = false;
            continue;
          } else return false;
      ...
      return i ? (t = this.test_match(i, o[r]), t !== false ? t : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var i = this.next();
      return i || this.lex();
    ...
    }, options: { "case-insensitive": true }, performAction: function(i, n, r, o) {
      switch (r) {
        case 0:
          break;
        case 1:
...
K.parser = K;
const St = K, $t = mt.pie, G = { sections: {}, showData: false };
...
const At = structuredClone($t), Et = () => structuredClone(At), wt = () => {
  ...
  Q = e;
}, Ot = () => Q, Pt = { getConfig: Et, clear: wt, setDiagramTitle: ht, getDiagramTitle: ct, setAccTitle: ot, getAccTitle: lt, setAccDescription: at, getAccDescription: rt, addSection: Tt, getSections: It, cleanupValue: Dt, setShowData: Ct, getShowData: Ot }, Vt = (e) => `
  .pieCircle{
...
`, Nt = Vt, Lt = (e) => {
  const u = Object.entries(e).map((p) => ({ label: p[0], value: p[1] })).sort((p, g) => g.value - p.value);
  return bt().value((p) => p.value)(u);
}, Ft = (e, u, $, p) => {
...
` + e);
  ...
  const i = Lt(v), n = [c.pie1, c.pie2, c.pie3, c.pie4, c.pie5, c.pie6, c.pie7, c.pie8, c.pie9, c.pie10, c.pie11, c.pie12], r = _t(n);
  ...
  const P = Math.max(...s.selectAll("text").nodes().map((f) => (f == null ? void 0 : f.getBoundingClientRect().width) ?? 0)), _ = I + a + l + d + P;
  T.attr("viewBox", `0 0 ${_} ${k}`), pt(T, k, _, y.useMaxWidth);
}, Rt = { draw: Ft }, qt = { parser: St, db: Pt, renderer: Rt, styles: Nt };
export {
  qt as diagram
};

import { n as Ut, o as zt, s as Mt, a as Ht, c as Xt, b as Kt, g as Y, j as ot, l as D, q as Wt, a1 as Jt } from "./index.Dfumm3oK.1760966607190.js";
var gt = function() {
  var t = function(C, r, n, i) {
    ...
    for (var dt in this.yy) Object.prototype.hasOwnProperty.call(this.yy, dt) && (A.yy[dt] = this.yy[dt]);
    ...
    for (var _, L, m, pt, N = {}, it, b, Ct, rt; ; ) {
      if (L = i[i.length - 1], this.defaultActions[L] ? m = this.defaultActions[L] : ((_ === null || typeof _ > "u") && (_ = jt()), m = $[L] && $[L][_]), typeof m > "u" || !m.length || !m[0]) {
        var St = "";
        rt = [];
        for (it in $[L]) this.terminals_[it] && it > st && rt.push("'" + this.terminals_[it] + "'");
        S.showPosition ? St = "Parse error on line " + (v + 1) + `:
` + S.showPosition() + `
Expecting ` + rt.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : St = "Parse error on line " + (v + 1) + ": Unexpected " + (_ == B ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(St, { text: S.match, token: this.terminals_[_] || _, line: S.yylineno, loc: yt, expected: rt });
      }
      if (m[0] instanceof Array && m.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + L + ", token: " + _);
      switch (m[0]) {
        case 1:
    ...
    var C = { EOF: 1, parseError: function(n, i) {
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: i ? (i.length === o.length ? this.yylloc.first_column : 0) + o[o.length - i.length].length - i[0].length : this.yylloc.first_column - n }, this.options.ranges && (this.yylloc.range = [p[0], p[0] + this.yyleng - n]), this.yyleng = this.yytext.length, this;
    }, more: function() {
...
` + n + "^";
      ...
      var i, o, p;
      if (this.options.backtrack_lexer && (p = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (p.yylloc.range = this.yylloc.range.slice(0))), o = r[0].match(/(?:\r\n?|\n).*/g), o && (this.yylineno += o.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: o ? o[o.length - 1].length - o[o.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + r[0].length }, this.yytext += r[0], this.match += r[0], this.matches = r, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(r[0].length), this.matched += r[0], i = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), i) return i;
      if (this._backtrack) {
      ...
      for (var p = this._currentRules(), e = 0; e < p.length; e++) if (i = this._input.match(this.rules[p[e]]), i && (!n || i[0].length > n[0].length)) {
        if (n = i, o = e, this.options.backtrack_lexer) {
          if (r = this.test_match(i, p[e]), r !== false) return r;
          if (this._backtrack) {
            n = false;
            continue;
          } else return false;
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    ...
    }, options: { "case-insensitive": true }, performAction: function(n, i, o, p) {
      switch (o) {
        case 0:
          return 40;
        case 1:
...
let $t = qt, lt = [], P = wt();
const Bt = () => ({ relations: [], states: {}, documents: {} });
let ct = { root: Bt() }, g = ct.root, F = 0, Lt = 0;
const ie = { LINE: 0, DOTTED_LINE: 1 }, re = { AGGREGATION: 0, EXTENSION: 1, COMPOSITION: 2, DEPENDENCY: 3 }, nt = (t) => JSON.parse(JSON.stringify(t)), ne = (t) => {
  D.info("Setting root doc", t), lt = t;
}, ae = () => lt, at = (t, s, a) => {
  if (s.stmt === It) at(t, s.state1, true), at(t, s.state2, false);
    ...
    if (h.length > 0 && f.length > 0) {
      const y = { stmt: _t, id: Jt(), type: "divider", doc: nt(f) };
      h.push(nt(y)), s.doc = h;
    }
    s.doc.forEach((y) => at(s, y, true));
  }
}, le = () => (at({ id: "root" }, { id: "root", doc: lt }, true), { id: "root", doc: lt }), ce = (t) => {
  let s;
  t.doc ? s = t.doc : s = t, D.info(s), Pt(true), D.info("Extract", s), s.forEach((a) => {
    switch (a.stmt) {
      case _t:
...
function ye(t, s, a) {
  ...
  I(h, f, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), I(d, y, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), g.relations.push({ id1: h, id2: d, relationTitle: ot.sanitizeText(a, Y()) });
}
const Ft = function(t, s, a) {
  if (typeof t == "object") ye(t, s, a);
  else {
    const h = mt(t.trim()), f = Tt(t), d = fe(s.trim()), y = de(s);
    I(h, f), I(d, y), g.relations.push({ id1: h, id2: d, title: ot.sanitizeText(a, Y()) });
  }
}, kt = function(t, s) {
  ...
  const a = P[t];
  s == null ? void 0 : s.split(se).forEach((h) => {

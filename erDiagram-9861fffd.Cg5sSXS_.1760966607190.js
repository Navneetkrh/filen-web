import { n as Et, o as mt, a as gt, s as kt, b as xt, c as Rt, g as Z, l as V, d as rt, u as Ot, e as bt, q as Nt, r as Tt, X as At } from "./index.Dfumm3oK.1760966607190.js";
import { G as Mt } from "./graph.DhjqBz52.1760966607190.js";
import { l as St } from "./layout.CqBSxywX.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import { l as wt } from "./line.jIL4itrg.1760966607190.js";
...
function Lt(t) {
  if (!Dt(t)) throw TypeError("Invalid UUID");
  let e;
...
function Yt(t, e, r) {
  function u(l, p, f, o) {
    var h;
    if (typeof l == "string" && (l = Bt(l)), typeof p == "string" && (p = Lt(p)), ((h = p) === null || h === void 0 ? void 0 : h.length) !== 16) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
    let _ = new Uint8Array(16 + l.length);
    if (_.set(p), _.set(l, p.length), _ = r(_), _[6] = _[6] & 15 | e, _[8] = _[8] & 63 | 128, f) {
      o = o || 0;
      for (let m = 0; m < 16; ++m) f[o + m] = _[m];
      return f;
    }
    return vt(_);
  }
...
function Ft(t) {
  ...
  if (typeof t == "string") {
    ...
    t = [];
    for (let o = 0; o < f.length; ++o) t.push(f.charCodeAt(o));
  } else Array.isArray(t) || (t = Array.prototype.slice.call(t));
  t.push(128);
  const u = t.length / 4 + 2, l = Math.ceil(u / 16), p = new Array(l);
  for (let f = 0; f < l; ++f) {
    const o = new Uint32Array(16);
    for (let h = 0; h < 16; ++h) o[h] = t[f * 64 + h * 4] << 24 | t[f * 64 + h * 4 + 1] << 16 | t[f * 64 + h * 4 + 2] << 8 | t[f * 64 + h * 4 + 3];
    p[f] = o;
  }
  p[l - 1][14] = (t.length - 1) * 8 / Math.pow(2, 32), p[l - 1][14] = Math.floor(p[l - 1][14]), p[l - 1][15] = (t.length - 1) * 8 & 4294967295;
  for (let f = 0; f < l; ++f) {
    const o = new Uint32Array(80);
    for (let y = 0; y < 16; ++y) o[y] = p[f][y];
    for (let y = 16; y < 80; ++y) o[y] = it(o[y - 3] ^ o[y - 8] ^ o[y - 14] ^ o[y - 16], 1);
...
var at = function() {
  var t = function(S, a, n, c) {
    ...
    return n;
  }, e = [6, 8, 10, 20, 22, 24, 26, 27, 28], r = [1, 10], u = [1, 11], l = [1, 12], p = [1, 13], f = [1, 14], o = [1, 15], h = [1, 21], _ = [1, 22], m = [1, 23], g = [1, 24], x = [1, 25], y = [6, 8, 10, 13, 15, 18, 19, 20, 22, 24, 26, 27, 28, 41, 42, 43, 44, 45], N = [1, 34], I = [27, 28, 46, 47], F = [41, 42, 43, 44, 45], W = [17, 34], C = [1, 54], T = [1, 53], M = [17, 34, 36, 38], R = { trace: function() {
    ...
    for (var J in this.yy) Object.prototype.hasOwnProperty.call(this.yy, J) && (H.yy[J] = this.yy[J]);
    ...
    for (var w, z, D, tt, G = {}, q, P, lt, j; ; ) {
      if (z = c[c.length - 1], this.defaultActions[z] ? D = this.defaultActions[z] : ((w === null || typeof w > "u") && (w = _t()), D = K[z] && K[z][w]), typeof D > "u" || !D.length || !D[0]) {
        var et = "";
        j = [];
        for (q in K[z]) this.terminals_[q] && q > ft && j.push("'" + this.terminals_[q] + "'");
        b.showPosition ? et = "Parse error on line " + (Q + 1) + `:
` + b.showPosition() + `
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : et = "Parse error on line " + (Q + 1) + ": Unexpected " + (w == ot ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(et, { text: b.match, token: this.terminals_[w] || w, line: b.yylineno, loc: $, expected: j });
      }
      if (D[0] instanceof Array && D.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + z + ", token: " + w);
      switch (D[0]) {
        case 1:
          c.push(w), E.push(b.yytext), i.push(b.yylloc), c.push(D[1]), w = null, st = b.yyleng, s = b.yytext, Q = b.yylineno, $ = b.yylloc;
          break;
        case 2:
          if (P = this.productions_[D[1]][1], G.$ = E[E.length - P], G._$ = { first_line: i[i.length - (P || 1)].first_line, last_line: i[i.length - 1].last_line, first_column: i[i.length - (P || 1)].first_column, last_column: i[i.length - 1].last_column }, pt && (G._$.range = [i[i.length - (P || 1)].range[0], i[i.length - 1].range[1]]), tt = this.performAction.apply(G, [s, st, Q, H.yy, D[1], E, i].concat(yt)), typeof tt < "u") return tt;
    ...
    var S = { EOF: 1, parseError: function(n, c) {
      if (this.yy.parser) this.yy.parser.parseError(n, c);
      else throw new Error(n);
    }, setInput: function(a, n) {
      return this.yy = n || this.yy || {}, this._input = a, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, input: function() {
      var a = this._input[0];
...
` + n + "^";
      ...
      var c, d, E;
      if (this.options.backtrack_lexer && (E = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (E.yylloc.range = this.yylloc.range.slice(0))), d = a[0].match(/(?:\r\n?|\n).*/g), d && (this.yylineno += d.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: d ? d[d.length - 1].length - d[d.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + a[0].length }, this.yytext += a[0], this.match += a[0], this.matches = a, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(a[0].length), this.matched += a[0], c = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), c) return c;
      if (this._backtrack) {
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    ...
    }, options: { "case-insensitive": true }, performAction: function(n, c, d, E) {
      switch (d) {
        case 0:
...
const Ut = at;
let U = {}, nt = [];
const Ht = { ZERO_OR_ONE: "ZERO_OR_ONE", ZERO_OR_MORE: "ZERO_OR_MORE", ONE_OR_MORE: "ONE_OR_MORE", ONLY_ONE: "ONLY_ONE", MD_PARENT: "MD_PARENT" }, zt = { NON_IDENTIFYING: "NON_IDENTIFYING", IDENTIFYING: "IDENTIFYING" }, dt = function(t, e = void 0) {
  ...
  let r = dt(t), u;
  for (u = e.length - 1; u >= 0; u--) r.attributes.push(e[u]), V.debug("Added attribute ", e[u].attributeName);
}, Vt = function(t, e, r, u) {
  let l = { entityA: t, roleA: e, entityB: r, relSpec: u };
  nt.push(l), V.debug("Added new relationship :", l);
}, Xt = () => nt, Qt = function() {
  U = {}, nt = [], Nt();
}, qt = { Cardinality: Ht, Identification: zt, getConfig: () => Z().er, addEntity: dt, addAttributes: Kt, getEntities: Gt, addRelationship: Vt, getRelationships: Xt, clear: Qt, setAccTitle: Rt, getAccTitle: xt, setAccDescription: kt, getAccDescription: gt, setDiagramTitle: mt, getDiagramTitle: Et }, L = { ONLY_ONE_START: "ONLY_ONE_START", ONLY_ONE_END: "ONLY_ONE_END", ZERO_OR_ONE_START: "ZERO_OR_ONE_START", ZERO_OR_ONE_END: "ZERO_OR_ONE_END", ONE_OR_MORE_START: "ONE_OR_MORE_START", ONE_OR_MORE_END: "ONE_OR_MORE_END", ZERO_OR_MORE_START: "ZERO_OR_MORE_START", ZERO_OR_MORE_END: "ZERO_OR_MORE_END", MD_PARENT_END: "MD_PARENT_END", MD_PARENT_START: "MD_PARENT_START" }, jt = function(t, e) {
  let r;
...
}, B = { ERMarkers: L, insertMarkers: jt }, Jt = /[^\dA-Za-z](\W)*/g;
...
const $t = function(t) {
  ...
  r.forEach((T) => {
    ...
    if (m = Math.max(m, n.width), g = Math.max(g, c.width), R = Math.max(n.height, c.height), h) {
      const d = T.attributeKeyTypeList !== void 0 ? T.attributeKeyTypeList.join(",") : "", E = t.append("text").classed("er entityLabel", true).attr("id", `${M}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Z().fontFamily).style("font-size", p + "px").text(d);
      a.kn = E;
      const i = E.node().getBBox();
      x = Math.max(x, i.width), R = Math.max(R, i.height);
    }
    if (_) {
      const d = t.append("text").classed("er entityLabel", true).attr("id", `${M}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Z().fontFamily).style("font-size", p + "px").text(T.attributeComment || "");
      a.cn = d;
  ...
  let F = 4;
  h && (F += 2), _ && (F += 2);
  const W = m + g + x + y, C = { width: Math.max(k.minEntityWidth, Math.max(f.width + k.entityPadding * 2, W + l * F)), height: r.length > 0 ? N : Math.max(k.minEntityHeight, f.height + k.entityPadding * 2) };
  if (r.length > 0) {
    const T = Math.max(0, (C.width - W - l * F) / (F / 2));
    ...
    o.forEach((O) => {
      ...
      O.nn.attr("transform", "translate(" + (a + l) + "," + v + ")");
      ...
      if (h) {
        O.kn.attr("transform", "translate(" + (c + l) + "," + v + ")");
      ...
      _ && (O.cn.attr("transform", "translate(" + (c + l) + "," + v + ")"), t.insert("rect", "#" + O.cn.node().id).classed(`er ${R}`, "true").attr("x", c).attr("y", M).attr("width", y + l * 2 + T).attr("height", O.height + u * 2)), M += O.height + u * 2, R = R === "attributeBoxOdd" ? "attributeBoxEven" : "attributeBoxOdd";
    });
  ...
  return u.forEach(function(p) {
    ...
    l = l === void 0 ? f : l;
    const h = "text-" + f, _ = o.append("text").classed("er entityLabel", true).attr("id", h).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", Z().fontFamily).style("font-size", k.fontSize + "px").text(e[p].alias ?? p), { width: m, height: g } = te(o, _, e[p].attributes), y = o.insert("rect", "#" + h).classed("er entityBox", true).attr("x", 0).attr("y", 0).attr("width", m).attr("height", g).node().getBBox();
    r.setNode(f, { width: y.width, height: y.height, shape: "rect", id: f });
  }), l;
}, re = function(t, e) {
  ...
  return t.forEach(function(r) {
    e.setEdge(X.get(r.entityA), X.get(r.entityB), { relationship: r }, ut(r));
  }), t;
};
let ct = 0;
const ae = function(t, e, r, u, l) {
  ct++;
  const p = r.edge(X.get(e.entityA), X.get(e.entityB), ut(e)), f = wt().x(function(N) {
    return N.x;
  }).y(function(N) {
    return N.y;
  }).curve(Tt), o = t.insert("path", "#" + u).classed("er relationshipLine", true).attr("d", f(p.points)).style("stroke", k.stroke).style("fill", "none");
  ...
  const _ = o.node().getTotalLength(), m = o.node().getPointAtLength(_ * 0.5), g = "rel" + ct, y = t.append("text").classed("er relationshipLabel", true).attr("id", g).attr("x", m.x).attr("y", m.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", Z().fontFamily).style("font-size", k.fontSize + "px").text(e.roleA).node().getBBox();
  ...
  B.insertMarkers(o, k);
  let h;
  h = new Mt({ multigraph: true, directed: true, compound: false }).setGraph({ rankdir: k.layoutDirection, marginx: 20, marginy: 20, nodesep: 100, edgesep: 100, ranksep: 100 }).setDefaultEdgeLabel(function() {
    return {};
  });
...
function oe(t = "", e = "") {
  ...
  return `${ht(e)}${ht(r)}${Wt(t, se)}`;
}
function ht(t = "") {
  return t.length > 0 ? `${t}-` : "";
}
const le = { setConf: $t, draw: ne }, ce = (t) => `
  .entityBox {
    fill: ${t.mainBkg};
    stroke: ${t.nodeBorder};
  }
...
`, he = ce, ge = { parser: Ut, db: qt, renderer: le, styles: he };
export {
  ge as diagram
};

...
var pt = function() {
  var e = function(f1, a, o, f) {
    ...
    var o = this, f = [0], n = [], S = [null], t = [], N1 = this.table, s = "", Y = 0, Yt = 0, Ce = 2, jt = 1, _e = t.slice.call(arguments, 1), _ = Object.create(this.lexer), d1 = { yy: {} };
    ...
    for (var G, E1, j, ht, v1 = {}, W1, r1, zt, Q1; ; ) {
      if (E1 = f[f.length - 1], this.defaultActions[E1] ? j = this.defaultActions[E1] : ((G === null || typeof G > "u") && (G = Be()), j = N1[E1] && N1[E1][G]), typeof j > "u" || !j.length || !j[0]) {
        var ft = "";
        Q1 = [];
        for (W1 in N1[E1]) this.terminals_[W1] && W1 > Ce && Q1.push("'" + this.terminals_[W1] + "'");
        _.showPosition ? ft = "Parse error on line " + (Y + 1) + `:
` + _.showPosition() + `
Expecting ` + Q1.join(", ") + ", got '" + (this.terminals_[G] || G) + "'" : ft = "Parse error on line " + (Y + 1) + ": Unexpected " + (G == jt ? "end of input" : "'" + (this.terminals_[G] || G) + "'"), this.parseError(ft, { text: _.match, token: this.terminals_[G] || G, line: _.yylineno, loc: lt, expected: Q1 });
      }
      if (j[0] instanceof Array && j.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + E1 + ", token: " + G);
      switch (j[0]) {
        case 1:
          f.push(G), S.push(_.yytext), t.push(_.yylloc), f.push(j[1]), G = null, Yt = _.yyleng, s = _.yytext, Y = _.yylineno, lt = _.yylloc;
          break;
        case 2:
          if (r1 = this.productions_[j[1]][1], v1.$ = S[S.length - r1], v1._$ = { first_line: t[t.length - (r1 || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (r1 || 1)].first_column, last_column: t[t.length - 1].last_column }, xe && (v1._$.range = [t[t.length - (r1 || 1)].range[0], t[t.length - 1].range[1]]), ht = this.performAction.apply(v1, [s, Yt, Y, d1.yy, j[1], S, t].concat(_e)), typeof ht < "u") return ht;
    ...
    var f1 = { EOF: 1, parseError: function(o, f) {
      if (this.yy.parser) this.yy.parser.parseError(o, f);
      else throw new Error(o);
    }, setInput: function(a, o) {
      return this.yy = o || this.yy || {}, this._input = a, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, input: function() {
      var a = this._input[0];
...
` + o + "^";
      ...
      var f, n, S;
      if (this.options.backtrack_lexer && (S = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (S.yylloc.range = this.yylloc.range.slice(0))), n = a[0].match(/(?:\r\n?|\n).*/g), n && (this.yylineno += n.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: n ? n[n.length - 1].length - n[n.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + a[0].length }, this.yytext += a[0], this.match += a[0], this.matches = a, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(a[0].length), this.matched += a[0], f = this.performAction.call(this, this.yy, this, o, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), f) return f;
      if (this._backtrack) {
      ...
      for (var S = this._currentRules(), t = 0; t < S.length; t++) if (f = this._input.match(this.rules[S[t]]), f && (!o || f[0].length > o[0].length)) {
        if (o = f, n = t, this.options.backtrack_lexer) {
          if (a = this.test_match(f, S[t]), a !== false) return a;
          if (this._backtrack) {
            o = false;
            continue;
          } else return false;
      ...
      return o ? (a = this.test_match(o, S[n]), a !== false ? a : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var o = this.next();
      return o || this.lex();
    ...
    }, options: {}, performAction: function(o, f, n, S) {
      switch (n) {
        case 0:
...
let Xt = 0, L1 = et(), D = {}, H = [], V1 = {}, c1 = [], $1 = {}, tt = {}, Z1 = 0, At = true, z, st, ut = [];
const it = (e) => Ne.sanitizeText(e, L1), P1 = function(e) {
  ...
  let U, F = e;
  F !== void 0 && F.trim().length !== 0 && (D[F] === void 0 && (D[F] = { id: F, labelType: "text", domId: Oe + F + "-" + Xt, styles: [], classes: [] }), Xt++, u !== void 0 ? (L1 = et(), U = it(u.text.trim()), D[F].labelType = u.type, U[0] === '"' && U[U.length - 1] === '"' && (U = U.substring(1, U.length - 1)), D[F].text = U) : D[F].text === void 0 && (D[F].text = e), i !== void 0 && (D[F].type = i), r == null ? void 0 : r.forEach(function(w) {
    D[F].styles.push(w);
  }), c == null ? void 0 : c.forEach(function(w) {
    D[F].classes.push(w);
  ...
  const h = i.text;
  if (h !== void 0 && (l.text = it(h.text.trim()), l.text[0] === '"' && l.text[l.text.length - 1] === '"' && (l.text = l.text.substring(1, l.text.length - 1)), l.labelType = h.type), i !== void 0 && (l.type = i.type, l.stroke = i.stroke, l.length = i.length), (l == null ? void 0 : l.length) > 10 && (l.length = 10), H.length < (L1.maxEdges ?? 500)) J1.info("abc78 pushing edge..."), H.push(l);
  else throw new Error(`Edge limit exceeded. ${H.length} edges found, but the limit is ${L1.maxEdges}.
...
You have to call mermaid.initialize.`);
  ...
  let r, c;
  for (r = 0; r < e.length; r++) for (c = 0; c < u.length; c++) qt(e[r], u[c], i);
}, Qt = function(e, u) {
  ...
  e.forEach(function(i) {
    if (i >= H.length) throw new Error(`The index ${i} for linkStyle is out of bounds. Valid indices for linkStyle are between 0 and ${H.length - 1}. (Help: Ensure that the index is within the range of existing edges.)`);
    i === "default" ? H.defaultStyle = u : (dt.isSubstringInArray("fill", u) === -1 && u.push("fill:none"), H[i].style = u);
  });
}, Jt = function(e, u) {
  e.split(",").forEach(function(i) {
    V1[i] === void 0 && (V1[i] = { id: i, styles: [], textStyles: [] }), u == null ? void 0 : u.forEach(function(r) {
      if (r.match("color")) {
  ...
  (u._groups || u)[0][0] === null && (u = w1("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), w1(e).select("svg").selectAll("g.node").on("mouseover", function() {
    ...
    u.transition().duration(500).style("opacity", 0), w1(this).classed("hover", false);
  });
};
ut.push(ce);
const oe = function(e = "gen-1") {
  D = {}, V1 = {}, H = [], ut = [ce], c1 = [], $1 = {}, Z1 = 0, tt = {}, At = true, st = e, L1 = et(), we();
}, le = (e) => {
  st = e || "gen-2";
}, he = function() {
  ...
  function l(X) {
    ...
    return { nodeList: X.filter(function(k) {
      const l1 = typeof k;
      return k.stmt && k.stmt === "dir" ? (A1 = k.value, false) : k.trim() === "" ? false : l1 in o1 ? o1[l1].hasOwnProperty(k) ? false : o1[l1][k] = true : p1.includes(k) ? false : p1.push(k);
    }), dir: A1 };
  }
  let h = [];
  ...
  const w = { id: r, nodes: h, title: c.trim(), classes: [], dir: F, labelType: i.type };
...
const pe = [], Ae = function(e, u) {
  ...
  if (pe[O1] = u, c1[u].id === e) return { result: true, count: 0 };
  let r = 0, c = 1;
  for (; r < i.length; ) {
    const l = Ge(i[r]);
    if (l >= 0) {
      const h = Ae(e, l);
      if (h.result) return { result: true, count: c + h.count };
      c = c + h.count;
    }
    r = r + 1;
  }
  ...
  return c1;
}, be = () => At ? (At = false, true) : false, Me = (e) => {
  ...
  let r;
  if (u) {
    if (r = Me(u), r.stroke !== i.stroke) return { type: "INVALID", stroke: "INVALID" };
    if (r.type === "arrow_open") r.type = i.type;
    else {
      if (r.type !== i.type) return { type: "INVALID", stroke: "INVALID" };
...
}, Te = { firstGraph: be }, je = { defaultConfig: () => Re.flowchart, setAccTitle: Ie, getAccTitle: Le, getAccDescription: Ve, setAccDescription: ve, addVertex: Ht, lookUpDomId: P1, addLink: Wt, updateLinkInterpolate: Qt, updateLink: Zt, addClass: Jt, setDirection: $t, setClass: nt, setTooltip: Pe, getTooltip: ee, setClickEvent: se, setLink: te, bindFunctions: ue, getDirection: ie, getVertices: ne, getEdges: re, getClasses: ae, clear: oe, setGen: le, defaultStyle: he, addSubGraph: fe, getDepthFirstPos: de, indexNodes: Ee, getSubGraphs: ke, destructLink: ge, lex: Te, exists: De, makeUniq: Fe, setDiagramTitle: ye, getDiagramTitle: me }, He = Object.freeze(Object.defineProperty({ __proto__: null, addClass: Jt, addLink: Wt, addSingleLink: qt, addSubGraph: fe, addVertex: Ht, bindFunctions: ue, clear: oe, default: je, defaultStyle: he, destructLink: ge, firstGraph: be, getClasses: ae, getDepthFirstPos: de, getDirection: ie, getEdges: re, getSubGraphs: ke, getTooltip: ee, getVertices: ne, indexNodes: Ee, lex: Te, lookUpDomId: P1, setClass: nt, setClickEvent: se, setDirection: $t, setGen: le, setLink: te, updateLink: Zt, updateLinkInterpolate: Qt }, Symbol.toStringTag, { value: "Module" }));
export {
  He as d,
  je as f,
  Xe as p

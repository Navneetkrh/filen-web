import { a as yt, s as ft, b as dt, c as pt, n as gt, o as mt, g as I, d as W, e as xt, q as kt } from "./index.Dfumm3oK.1760966607190.js";
import { a as _t, g as it, f as bt, d as vt } from "./svgDrawCommon-08f97a94.DPvXNwx2.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import { a as Q } from "./arc.Budyuigr.1760966607190.js";
...
var G = function() {
  var t = function(p, s, r, a) {
    ...
    return r;
  }, e = [6, 8, 10, 11, 12, 14, 16, 17, 18], i = [1, 9], l = [1, 10], n = [1, 11], h = [1, 12], c = [1, 13], f = [1, 14], y = { trace: function() {
  }, yy: {}, symbols_: { error: 2, start: 3, journey: 4, document: 5, EOF: 6, line: 7, SPACE: 8, statement: 9, NEWLINE: 10, title: 11, acc_title: 12, acc_title_value: 13, acc_descr: 14, acc_descr_value: 15, acc_descr_multiline_value: 16, section: 17, taskName: 18, taskData: 19, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "journey", 6: "EOF", 8: "SPACE", 10: "NEWLINE", 11: "title", 12: "acc_title", 13: "acc_title_value", 14: "acc_descr", 15: "acc_descr_value", 16: "acc_descr_multiline_value", 17: "section", 18: "taskName", 19: "taskData" }, productions_: [0, [3, 3], [5, 0], [5, 2], [7, 2], [7, 1], [7, 1], [7, 1], [9, 1], [9, 2], [9, 2], [9, 1], [9, 1], [9, 2]], performAction: function(s, r, a, u, d, o, w) {
    var k = o.length - 1;
    switch (d) {
      case 1:
        return o[k - 1];
  ...
  }, table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, t(e, [2, 2], { 5: 3 }), { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: i, 12: l, 14: n, 16: h, 17: c, 18: f }, t(e, [2, 7], { 1: [2, 1] }), t(e, [2, 3]), { 9: 15, 11: i, 12: l, 14: n, 16: h, 17: c, 18: f }, t(e, [2, 5]), t(e, [2, 6]), t(e, [2, 8]), { 13: [1, 16] }, { 15: [1, 17] }, t(e, [2, 11]), t(e, [2, 12]), { 19: [1, 18] }, t(e, [2, 4]), t(e, [2, 9]), t(e, [2, 10]), t(e, [2, 13])], defaultActions: {}, parseError: function(s, r) {
    ...
    for (var _, E, b, q, A = {}, N, $, K, B; ; ) {
      if (E = a[a.length - 1], this.defaultActions[E] ? b = this.defaultActions[E] : ((_ === null || typeof _ > "u") && (_ = ut()), b = w[E] && w[E][_]), typeof b > "u" || !b.length || !b[0]) {
        var O = "";
        B = [];
        for (N in w[E]) this.terminals_[N] && N > lt && B.push("'" + this.terminals_[N] + "'");
        x.showPosition ? O = "Parse error on line " + (R + 1) + `:
` + x.showPosition() + `
Expecting ` + B.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : O = "Parse error on line " + (R + 1) + ": Unexpected " + (_ == J ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(O, { text: x.match, token: this.terminals_[_] || _, line: x.yylineno, loc: Y, expected: B });
      }
      if (b[0] instanceof Array && b.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + E + ", token: " + _);
      switch (b[0]) {
        case 1:
          a.push(_), d.push(x.yytext), o.push(x.yylloc), a.push(b[1]), _ = null, Z = x.yyleng, k = x.yytext, R = x.yylineno, Y = x.yylloc;
          break;
        case 2:
          if ($ = this.productions_[b[1]][1], A.$ = d[d.length - $], A._$ = { first_line: o[o.length - ($ || 1)].first_line, last_line: o[o.length - 1].last_line, first_column: o[o.length - ($ || 1)].first_column, last_column: o[o.length - 1].last_column }, ht && (A._$.range = [o[o.length - ($ || 1)].range[0], o[o.length - 1].range[1]]), q = this.performAction.apply(A, [k, Z, R, S.yy, b[1], d, o].concat(ct)), typeof q < "u") return q;
    ...
    var p = { EOF: 1, parseError: function(r, a) {
      if (this.yy.parser) this.yy.parser.parseError(r, a);
      else throw new Error(r);
    }, setInput: function(s, r) {
      return this.yy = r || this.yy || {}, this._input = s, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, input: function() {
      var s = this._input[0];
...
` + r + "^";
      ...
      var a, u, d;
      if (this.options.backtrack_lexer && (d = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (d.yylloc.range = this.yylloc.range.slice(0))), u = s[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + s[0].length }, this.yytext += s[0], this.match += s[0], this.matches = s, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(s[0].length), this.matched += s[0], a = this.performAction.call(this, this.yy, this, r, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), a) return a;
      if (this._backtrack) {
      ...
      for (var d = this._currentRules(), o = 0; o < d.length; o++) if (a = this._input.match(this.rules[d[o]]), a && (!r || a[0].length > r[0].length)) {
        if (r = a, u = o, this.options.backtrack_lexer) {
          if (s = this.test_match(a, d[o]), s !== false) return s;
          if (this._backtrack) {
            r = false;
            continue;
          } else return false;
      ...
      return r ? (s = this.test_match(r, d[u]), s !== false ? s : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var r = this.next();
      return r || this.lex();
    ...
    }, options: { "case-insensitive": true }, performAction: function(r, a, u, d) {
      switch (u) {
        case 0:
          break;
        case 1:
...
const H = [], V = [], F = [], $t = function() {
  H.length = 0, V.length = 0, C = "", F.length = 0, kt();
}, Tt = function(t) {
  C = t, H.push(t);
}, Mt = function() {
  return H;
  ...
  const h = n.map((f) => f.trim()), c = { section: C, type: C, people: h, task: t, score: l };
  F.push(c);
}, It = function(t) {
  ...
  let e = true;
  for (const [i, l] of F.entries()) t(i), e = e && l.processed;
  return e;
}, At = function() {
  return Et();
}, tt = { getConfig: () => I().journey, clear: $t, setDiagramTitle: mt, getDiagramTitle: gt, setAccTitle: pt, getAccTitle: dt, setAccDescription: ft, getAccDescription: yt, addSection: Tt, getSections: Mt, getTasks: St, addTask: Pt, addTaskOrg: It, getActors: At }, Ct = (t) => `.label {
...
`, Vt = Ct, U = function(t, e) {
  ...
  n.x = e.x, n.y = e.y, n.fill = e.fill, n.width = i.width * e.taskCount + i.diagramMarginX * (e.taskCount - 1), n.height = i.height, n.class = "journey-section section-type-" + e.num, n.rx = 3, n.ry = 3, U(l, n), ot(i)(e.text, l, n.x, n.y, n.width, n.height, { class: "journey-section section-type-" + e.num }, i, e.colour);
};
let et = -1;
const Nt = function(t, e, i) {
  ...
  et++;
  const h = 300 + 5 * 30;
  n.append("line").attr("id", "task" + et).attr("x1", l).attr("y1", e.y).attr("x2", l).attr("y2", h).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Ft(n, { cx: l, cy: 300 + (5 - e.score) * 30, score: e.score });
  const c = it();
  c.x = e.x, c.y = e.y, c.fill = e.fill, c.width = i.width, c.height = i.height, c.class = "task task-type-" + e.num, c.rx = 3, c.ry = 3, U(n, c);
  let f = e.x + 14;
  e.people.forEach((y) => {
    const m = e.actors[y].color, g = { cx: f, cy: e.y, r: 7, fill: m, stroke: "#000", title: y, pos: e.actors[y].position };
    rt(n, g), f += 10;
  }), ot(i)(e.task, n, c.x, c.y, c.width, c.height, { class: "task" }, i, e.colour);
}, Bt = function(t, e) {
  _t(t, e);
...
}, L = { drawRect: U, drawCircle: rt, drawSection: Rt, drawText: at, drawLabel: Lt, drawTask: Nt, drawBackgroundRect: Bt, initGraphics: jt }, zt = function(t) {
...
function Yt(t) {
  ...
  Object.keys(M).forEach((l) => {
    const n = M[l].color, h = { cx: 20, cy: i, r: 7, fill: n, stroke: "#000", pos: M[l].position };
    L.drawCircle(t, h);
    const c = { x: 40, y: i + 7, fill: "#666", text: l, textMargin: e.boxTextMargin | 5 };
    L.drawText(t, c), i += 20;
  });
}
const j = I().journey, P = j.leftMargin, qt = function(t, e, i, l) {
  ...
  for (const o in M) delete M[o];
  let s = 0;
  p.forEach((o) => {
    M[o] = { color: n.actorColours[s % n.actorColours.length], position: s }, s++;
...
}, v = { data: { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, verticalPos: 0, sequenceItems: [], init: function() {
  ...
  return this.data;
} }, X = j.sectionFills, st = j.sectionColours, Ot = function(t, e, i) {
  const l = I().journey;
  let n = "";
  ...
  for (const [p, s] of e.entries()) {
    if (n !== s.section) {
      ...
      const d = { x: p * l.taskMargin + p * l.width + P, y: 50, text: s.section, fill: y, num: g, colour: m, taskCount: a };
...
}, nt = { setConf: zt, draw: qt }, Jt = { parser: wt, db: tt, renderer: nt, styles: Vt, init: (t) => {

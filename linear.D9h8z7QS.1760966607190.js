import { al as un, am as I, an as U, ao as fn, ap as Y } from "./index.Dfumm3oK.1760966607190.js";
import { i as cn } from "./init.Gi6I4Gst.1760966607190.js";
function F(n, t) {
...
function pn(n, t, e) {
  ...
  if (r) if (a < 0) for (let o = 0; o < u; ++o) c[o] = (f - o) / -a;
...
function D(n) {
  ...
  var t;
  return new B({ fill: t[1], align: t[2], sign: t[3], symbol: t[4], zero: t[5], width: t[6], comma: t[7], precision: t[8] && t[8].slice(1), trim: t[9], type: t[10] });
}
...
const H = { "%": (n, t) => (n * 100).toFixed(t), b: (n) => Math.round(n).toString(2), c: (n) => n + "", d: bn, e: (n, t) => n.toExponential(t), f: (n, t) => n.toFixed(t), g: (n, t) => n.toPrecision(t), o: (n) => Math.round(n).toString(8), p: (n, t) => Z(n * 100, t), r: Z, s: Fn, X: (n) => Math.round(n).toString(16).toUpperCase(), x: (n) => Math.round(n).toString(16) };
function J(n) {
  return n;
}
...
function Rn(n) {
  ...
  function o(h) {
    ...
    d === "n" ? (T = true, d = "g") : H[d] || (w === void 0 && (w = 12), G = true, d = "g"), (k || l === "0" && p === "=") && (k = true, l = "0", p = "=");
  ...
  return { format: o, formatPrefix: s };
}
var $, tn, rn;

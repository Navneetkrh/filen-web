import { a as F, c as bn, b as Wn, d as L, k as zn, e as Xn, g as Hn, j as P, l as gn, m as xn, n as En, t as Un, o as kn, p as jn, q as Jn, G as x, f as s, h as w, i as g, r as M, v as y, s as Y } from "./graph.DhjqBz52.1760966607190.js";
import { ar as A, as as Kn, at as Zn, au as yn, av as B, aw as Nn, ax as Qn, ay as Ln, az as J, aA as ne, aB as ee, aC as K, aD as re, aE as _n, aF as te, aG as ie, aH as U } from "./index.Dfumm3oK.1760966607190.js";
var ae = /\s/;
function oe(n) {
  for (var e = n.length; e-- && ae.test(n.charAt(e)); ) ;
  return e;
}
var ue = /^\s+/;
function de(n) {
  return n && n.slice(0, oe(n) + 1).replace(ue, "");
}
var un = NaN, fe = /^[-+]0x[0-9a-f]+$/i, se = /^0b[01]+$/i, ce = /^0o[0-7]+$/i, he = parseInt;
function le(n) {
  ...
  n = de(n);
  var r = se.test(n);
  return r || ce.test(n) ? he(n.slice(2), r ? 2 : 8) : fe.test(n) ? un : +n;
}
var ve = 1 / 0, pe = 17976931348623157e292;
function S(n) {
  if (!n) return n === 0 ? n : 0;
  if (n = le(n), n === ve || n === -1 / 0) {
    var e = n < 0 ? -1 : 1;
    return e * pe;
  }
  return n === n ? n : 0;
...
function me(n) {
  return Kn(Zn(n, void 0, _), n + "");
}
var be = 1, ge = 4;
function xe(n) {
  return Wn(n, be | ge);
}
var Cn = Object.prototype, Ee = Cn.hasOwnProperty, ke = yn(function(n, e) {
  n = Object(n);
  var r = -1, t = e.length, i = t > 2 ? e[2] : void 0;
  for (i && B(e[0], e[1], i) && (t = 1); ++r < t; ) for (var o = e[r], a = Nn(o), u = -1, d = a.length; ++u < d; ) {
    var f = a[u], c = n[f];
    (c === void 0 || Qn(c, Cn[f]) && !Ee.call(n, f)) && (n[f] = o[f]);
  }
  return n;
});
function G(n) {
...
function Le(n, e, r) {
  ...
  if (!t) return -1;
  var i = r == null ? 0 : we(r);
  return i < 0 && (i = Ne(t + i, 0)), Xn(n, L(e), i);
}
var Z = ye(Le);
function In(n, e) {
...
function D(n, e) {
  var r = {};
  return e = L(e), xn(n, function(t, i, o) {
    ee(r, i, e(t, i, o));
  }), r;
}
function Q(n, e, r) {
  for (var t = -1, i = n.length; ++t < i; ) {
    var o = n[t], a = e(o);
    if (a != null && (u === void 0 ? a === a && !F(a) : r(a, u))) var u = a, d = o;
  }
  return d;
}
function E(n) {
...
function R(n) {
  return n && n.length ? Q(n, K, Rn) : void 0;
}
function nn(n, e) {
  return n && n.length ? Q(n, L(e), Rn) : void 0;
}
function Re(n, e, r, t) {
  if (!A(n)) return n;
  e = En(e, n);
  for (var i = -1, o = e.length, a = o - 1, u = n; u != null && ++i < o; ) {
    ...
    if (i != a) {
      var c = u[d];
      f = void 0, f === void 0 && (f = A(c) ? c : re(e[i + 1]) ? [] : {});
    }
    _n(u, d, f), u = u[d];
  }
  return n;
...
function Ge(n, e, r, t) {
  for (var i = -1, o = Be(Ae((e - n) / (r || 1)), 0), a = Array(o); o--; ) a[++i] = n, n += r;
  return a;
}
function Ve(n) {
  return function(e, r, t) {
...
var N = Ve(), O = yn(function(n, e) {
  if (n == null) return [];
  var r = e.length;
  return r > 1 && B(n, e[0], e[1]) ? e = [] : r > 2 && B(e[0], e[1], e[2]) && (e = [e[0]]), Se(n, bn(e), []);
}), Ye = 0;
function en(n) {
  var e = ++Ye;
  return Jn(n) + e;
...
class qe {
  ...
  toString() {
    for (var e = [], r = this._sentinel, t = r._prev; t !== r; ) e.push(JSON.stringify(t, We)), t = t._prev;
    return "[" + e.join(", ") + "]";
  }
}
function dn(n) {
...
function Xe(n, e) {
  ...
  var r = Ue(n, e || ze), t = He(r.graph, r.buckets, r.zeroIdx);
...
function Je(n) {
  var e = [], r = {}, t = {};
  function i(o) {
    w(t, o) || (t[o] = true, r[o] = true, s(n.outEdges(o), function(a) {
...
function Ze(n) {
  ...
  return s(n.nodes(), function(r) {
    ...
    e.setEdge(r.v, r.w, { weight: t.weight + i.weight, minlen: Math.max(t.minlen, i.minlen) });
  }), e;
}
function Tn(n) {
...
function tr(n) {
  function e(r) {
    ...
    if (t.length && s(t, e), w(i, "minRank")) {
      ...
      for (var o = i.minRank, a = i.maxRank + 1; o < a; ++o) cn(n, "borderLeft", "_bl", r, i, o), cn(n, "borderRight", "_br", r, i, o);
    }
  }
  s(n.children(), e);
}
...
function ar(n) {
  var e = n.graph().rankdir.toLowerCase();
  (e === "bt" || e === "rl") && or(n), (e === "lr" || e === "rl") && (ur(n), On(n));
}
function On(n) {
...
function fr(n, e) {
  ...
  if (o !== t + 1) {
    n.removeEdge(e);
    var f, c, h;
    for (h = 0, ++t; t < o; ++h, ++t) u.points = [], c = { width: 0, height: 0, edgeLabel: u, edgeObj: e, rank: t }, f = C(n, "edge", c, "_d"), t === d && (c.width = u.width, c.height = u.height, c.dummy = "edge-label", c.labelpos = u.labelpos), n.setEdge(r, f, { weight: u.weight }, a), h === 0 && n.graph().dummyChains.push(f), r = f;
...
function sr(n) {
  s(n.graph().dummyChains, function(e) {
    ...
    for (n.setEdge(r.edgeObj, t); r.dummy; ) i = n.successors(e)[0], n.removeNode(e), t.points.push({ x: r.x, y: r.y }), r.dummy === "edge-label" && (t.x = r.x, t.y = r.y, t.width = r.width, t.height = r.height), e = i, r = n.node(e);
  });
}
function rn(n) {
  var e = {};
...
function Pn(n) {
  var e = new x({ directed: false }), r = n.nodes()[0], t = n.nodeCount();
  e.setNode(r, {});
  for (var i, o; cr(e, n) < t; ) i = hr(e, n), o = e.hasNode(i.v) ? T(n, i) : -T(n, i), lr(e, n, o);
  return e;
}
function cr(n, e) {
  function r(t) {
...
function Fn(n, e, r, t, i, o) {
  w(t, e) || (t[e] = true, r || o.push(e), s(i(e), function(a) {
    Fn(n, a, r, t, i, o);
  }), r && o.push(e));
}
function pr(n, e) {
...
function k(n) {
  ...
  var e = Pn(n);
  an(e), tn(e, n);
  for (var r, t; r = Gn(e); ) t = Vn(e, n, r), Yn(e, n, r, t);
}
function tn(n, e) {
  var r = pr(n, n.nodes());
...
function mr(n, e, r) {
  ...
  n.edge(r, i).cutvalue = An(n, e, r);
}
function An(n, e, r) {
  var t = n.node(r), i = t.parent, o = true, a = e.edge(r, i), u = 0;
  return a || (o = false, a = e.edge(i, r)), u = a.weight, s(e.nodeEdges(r), function(d) {
...
function an(n, e) {
  arguments.length < 2 && (e = n.nodes()[0]), Bn(n, {}, 1, e);
}
function Bn(n, e, r, t, i) {
  var o = r, a = n.node(t);
  return e[t] = true, s(n.neighbors(t), function(u) {
    w(e, u) || (r = Bn(n, e, r, u, t));
...
function Dn(n, e, r, t, i, o, a) {
  ...
  n.setParent(d, a), c.borderTop = d, n.setParent(f, a), c.borderBottom = f, s(u, function(h) {
    ...
    n.setEdge(d, v, { weight: b, minlen: I, nestingEdge: true }), n.setEdge(p, f, { weight: b, minlen: I, nestingEdge: true });
...
function Ir(n, e, r) {
  var t = Rr(n), i = new x({ compound: true }).setGraph({ root: t }).setDefaultNodeLabel(function(o) {
    return n.node(o);
  });
  return s(n.nodes(), function(o) {
    ...
    }), w(a, "minRank") && i.setNode(o, { borderLeft: a.borderLeft[e], borderRight: a.borderRight[e] }));
  }), i;
}
function Rr(n) {
...
function Tr(n, e) {
  for (var r = 0, t = 1; t < e.length; ++t) r += Mr(n, e[t - 1], e[t]);
  return r;
}
function Mr(n, e, r) {
  for (var t = $e(r, m(r, function(f, c) {
    return c;
  })), i = _(m(e, function(f) {
...
function Br(n, e) {
  ...
  t.sort(Gr(!!e)), d = pn(o, i, d), s(t, function(c) {
    d += c.vs.length, o.push(c.vs), a += c.barycenter * c.weight, u += c.weight, d = pn(o, i, d);
  });
  var f = { vs: _(o) };
  return u && (f.barycenter = a / u, f.weight = u), f;
}
function pn(n, e, r) {
  for (var t; e.length && (t = G(e)).i <= r; ) e.pop(), n.push(t.vs), r++;
  return r;
}
function Gr(n) {
  return function(e, r) {
...
function Dr(n) {
  var e = Mn(n), r = wn(n, N(1, e + 1), "inEdges"), t = wn(n, N(e - 1, -1, -1), "outEdges"), i = Or(n);
  mn(n, i);
...
function $r(n, e) {
  var r = new x();
  s(n, function(t) {
    var i = t.graph().root, o = $n(t, i, r, e);
    s(o.vs, function(a, u) {
      t.node(a).order = u;
    }), Cr(t, r, o.vs);
  });
...
function qr(n) {
  ...
  s(n.graph().dummyChains, function(r) {
    for (var t = n.node(r), i = t.edgeObj, o = Wr(n, e, i.v, i.w), a = o.path, u = o.lca, d = 0, f = a[d], c = true; r !== i.w; ) {
      if (t = n.node(r), c) {
  ...
  function t(o, a, u, d, f) {
    ...
    s(N(a, u), function(h) {
      c = o[h], n.node(c).dummy && s(n.predecessors(c), function(l) {
        var v = n.node(l);
        v.dummy && (v.order < d || v.order > f) && qn(r, l, c);
      });
    });
  }
  function i(o, a) {
...
function nt(n, e) {
  ...
  s(["u", "d"], function(o) {
    s(["l", "r"], function(a) {
      ...
      if (d !== e) {
        var c = y(d);
        f = a === "l" ? t - R(c) : i - E(c), f && (n[u] = D(d, function(h) {
          return h + f;
        }));
      }
    });
...
function tt(n, e, r) {
  return function(t, i, o) {
    ...
    if (d += a.width / 2, w(a, "labelpos")) switch (a.labelpos.toLowerCase()) {
      case "l":
        f = -a.width / 2;
        break;
      case "r":
    ...
    if (f && (d += r ? f : -f), f = 0, d += (a.dummy ? e : n) / 2, d += (u.dummy ? e : n) / 2, d += u.width / 2, w(u, "labelpos")) switch (u.labelpos.toLowerCase()) {
      case "l":
        f = u.width / 2;
        break;
      case "r":
...
function at(n) {
  n = Tn(n), ot(n), Ce(rt(n), function(e, r) {
    n.node(r).x = e;
  });
}
function ot(n) {
  var e = $(n), r = n.graph().ranksep, t = 0;
  s(e, function(i) {
...
var ft = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], st = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, ct = ["acyclicer", "ranker", "rankdir", "align"], ht = ["width", "height"], lt = { width: 0, height: 0 }, vt = ["minlen", "weight", "width", "height", "labeloffset"], pt = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" }, wt = ["labelpos"];
function mt(n) {
  var e = new x({ multigraph: true, compound: true }), r = H(n.graph());
  return e.setGraph(U({}, st, X(r, ft), V(r, ct))), s(n.nodes(), function(t) {
    var i = H(n.node(t));
    e.setNode(t, ke(X(i, ht), lt)), e.setParent(t, n.parent(t));
  }), s(n.edges(), function(t) {
    var i = H(n.edge(t));
    e.setEdge(t, U({}, pt, X(i, vt), V(i, wt)));
  }), e;
}
function bt(n) {
  var e = n.graph();
...
function Nt(n) {
  s(n.edges(), function(e) {
    var r = n.edge(e);
    if (w(r, "x")) switch ((r.labelpos === "l" || r.labelpos === "r") && (r.width -= r.labeloffset), r.labelpos) {
      case "l":
  ...
  s(e, function(r) {
    ...
    s(r, function(i, o) {
      ...
      a.order = o + t, s(a.selfEdges, function(u) {
        C(n, "selfedge", { width: u.label.width, height: u.label.height, rank: a.rank, order: o + ++t, e: u.e, label: u.label }, "_se");
      }), delete a.selfEdges;
    });
  });
}
function Rt(n) {
  s(n.nodes(), function(e) {
    ...
    if (r.dummy === "selfedge") {
      ...
      n.setEdge(r.e, r.label), n.removeNode(e), r.label.points = [{ x: i + 2 * a / 3, y: o - u }, { x: i + 5 * a / 6, y: o - u }, { x: i + a, y: o }, { x: i + 5 * a / 6, y: o + u }, { x: i + 2 * a / 3, y: o + u }], r.label.x = r.x, r.label.y = r.y;
    }
  });
}
function X(n, e) {
  return D(V(n, e), Number);
}
function H(n) {
  var e = {};

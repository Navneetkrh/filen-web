import { a as we, s as ve, c as $t, g as st, o as _e, n as ke, b as Pe, d as Lt, l as X, e as Le, f as Ie, j as v, i as At, q as Ae, u as B, R as nt, S as wt, T as te, Z as Ne, V as ee, W as Bt } from "./index.Dfumm3oK.1760966607190.js";
import { a as Se, b as zt, d as Me, g as Nt, c as Re, e as Ce } from "./svgDrawCommon-08f97a94.DPvXNwx2.1760966607190.js";
import { d as se } from "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import "./index.1760966607190.js";
var Yt = function() {
  var t = function(dt, w, k, L) {
    for (k = k || {}, L = dt.length; L--; k[dt[L]] = w) ;
    return k;
  }, e = [1, 2], o = [1, 3], s = [1, 4], i = [2, 4], a = [1, 9], c = [1, 11], l = [1, 13], p = [1, 14], r = [1, 16], x = [1, 17], T = [1, 18], u = [1, 24], g = [1, 25], m = [1, 26], _ = [1, 27], I = [1, 28], V = [1, 29], S = [1, 30], O = [1, 31], R = [1, 32], q = [1, 33], z = [1, 34], J = [1, 35], $ = [1, 36], H = [1, 37], U = [1, 38], F = [1, 39], W = [1, 41], Z = [1, 42], K = [1, 43], Q = [1, 44], tt = [1, 45], N = [1, 46], y = [1, 4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], P = [4, 5, 16, 50, 52, 53], j = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 54, 59, 60, 61, 62, 70], rt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], A = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 48, 50, 52, 53, 54, 59, 60, 61, 62, 70], Gt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 50, 52, 53, 54, 59, 60, 61, 62, 70], ht = [68, 69, 70], ot = [1, 120], Mt = { trace: function() {
  }, yy: {}, symbols_: { error: 2, start: 3, SPACE: 4, NEWLINE: 5, SD: 6, document: 7, line: 8, statement: 9, box_section: 10, box_line: 11, participant_statement: 12, create: 13, box: 14, restOfLine: 15, end: 16, signal: 17, autonumber: 18, NUM: 19, off: 20, activate: 21, actor: 22, deactivate: 23, note_statement: 24, links_statement: 25, link_statement: 26, properties_statement: 27, details_statement: 28, title: 29, legacy_title: 30, acc_title: 31, acc_title_value: 32, acc_descr: 33, acc_descr_value: 34, acc_descr_multiline_value: 35, loop: 36, rect: 37, opt: 38, alt: 39, else_sections: 40, par: 41, par_sections: 42, par_over: 43, critical: 44, option_sections: 45, break: 46, option: 47, and: 48, else: 49, participant: 50, AS: 51, participant_actor: 52, destroy: 53, note: 54, placement: 55, text2: 56, over: 57, actor_pair: 58, links: 59, link: 60, properties: 61, details: 62, spaceList: 63, ",": 64, left_of: 65, right_of: 66, signaltype: 67, "+": 68, "-": 69, ACTOR: 70, SOLID_OPEN_ARROW: 71, DOTTED_OPEN_ARROW: 72, SOLID_ARROW: 73, DOTTED_ARROW: 74, SOLID_CROSS: 75, DOTTED_CROSS: 76, SOLID_POINT: 77, DOTTED_POINT: 78, TXT: 79, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "SPACE", 5: "NEWLINE", 6: "SD", 13: "create", 14: "box", 15: "restOfLine", 16: "end", 18: "autonumber", 19: "NUM", 20: "off", 21: "activate", 23: "deactivate", 29: "title", 30: "legacy_title", 31: "acc_title", 32: "acc_title_value", 33: "acc_descr", 34: "acc_descr_value", 35: "acc_descr_multiline_value", 36: "loop", 37: "rect", 38: "opt", 39: "alt", 41: "par", 43: "par_over", 44: "critical", 46: "break", 47: "option", 48: "and", 49: "else", 50: "participant", 51: "AS", 52: "participant_actor", 53: "destroy", 54: "note", 57: "over", 59: "links", 60: "link", 61: "properties", 62: "details", 64: ",", 65: "left_of", 66: "right_of", 68: "+", 69: "-", 70: "ACTOR", 71: "SOLID_OPEN_ARROW", 72: "DOTTED_OPEN_ARROW", 73: "SOLID_ARROW", 74: "DOTTED_ARROW", 75: "SOLID_CROSS", 76: "DOTTED_CROSS", 77: "SOLID_POINT", 78: "DOTTED_POINT", 79: "TXT" }, productions_: [0, [3, 2], [3, 2], [3, 2], [7, 0], [7, 2], [8, 2], [8, 1], [8, 1], [10, 0], [10, 2], [11, 2], [11, 1], [11, 1], [9, 1], [9, 2], [9, 4], [9, 2], [9, 4], [9, 3], [9, 3], [9, 2], [9, 3], [9, 3], [9, 2], [9, 2], [9, 2], [9, 2], [9, 2], [9, 1], [9, 1], [9, 2], [9, 2], [9, 1], [9, 4], [9, 4], [9, 4], [9, 4], [9, 4], [9, 4], [9, 4], [9, 4], [45, 1], [45, 4], [42, 1], [42, 4], [40, 1], [40, 4], [12, 5], [12, 3], [12, 5], [12, 3], [12, 3], [24, 4], [24, 4], [25, 3], [26, 3], [27, 3], [28, 3], [63, 2], [63, 1], [58, 3], [58, 1], [55, 1], [55, 1], [17, 5], [17, 5], [17, 4], [22, 1], [67, 1], [67, 1], [67, 1], [67, 1], [67, 1], [67, 1], [67, 1], [67, 1], [56, 1]], performAction: function(w, k, L, b, M, h, Et) {
    var d = h.length - 1;
    switch (M) {
      case 3:
      ...
      case 16:
        ...
        break;
      case 18:
        this.$ = { type: "sequenceIndex", sequenceIndex: Number(h[d - 2]), sequenceIndexStep: Number(h[d - 1]), sequenceVisible: true, signalType: b.LINETYPE.AUTONUMBER };
        break;
      case 19:
        this.$ = { type: "sequenceIndex", sequenceIndex: Number(h[d - 1]), sequenceIndexStep: 1, sequenceVisible: true, signalType: b.LINETYPE.AUTONUMBER };
        break;
      case 20:
      ...
      case 64:
        ...
        break;
      case 65:
        this.$ = [h[d - 4], h[d - 1], { type: "addMessage", from: h[d - 4].actor, to: h[d - 1].actor, signalType: h[d - 3], msg: h[d], activate: true }, { type: "activeStart", signalType: b.LINETYPE.ACTIVE_START, actor: h[d - 1] }];
        break;
      case 66:
        this.$ = [h[d - 4], h[d - 1], { type: "addMessage", from: h[d - 4].actor, to: h[d - 1].actor, signalType: h[d - 3], msg: h[d] }, { type: "activeEnd", signalType: b.LINETYPE.ACTIVE_END, actor: h[d - 4] }];
        break;
      case 67:
    ...
    for (var Ct in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Ct) && (pt.yy[Ct] = this.yy[Ct]);
...
Expecting ` + Pt.join(", ") + ", got '" + (this.terminals_[G] || G) + "'" : Ot = "Parse error on line " + (_t + 1) + ": Unexpected " + (G == Jt ? "end of input" : "'" + (this.terminals_[G] || G) + "'"), this.parseError(Ot, { text: Y.match, token: this.terminals_[G] || G, line: Y.yylineno, loc: Dt, expected: Pt });
    ...
    var dt = { EOF: 1, parseError: function(k, L) {
      if (this.yy.parser) this.yy.parser.parseError(k, L);
      else throw new Error(k);
    }, setInput: function(w, k) {
      return this.yy = k || this.yy || {}, this._input = w, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, input: function() {
      var w = this._input[0];
...
` + k + "^";
      ...
      var L, b, M;
      if (this.options.backtrack_lexer && (M = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (M.yylloc.range = this.yylloc.range.slice(0))), b = w[0].match(/(?:\r\n?|\n).*/g), b && (this.yylineno += b.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: b ? b[b.length - 1].length - b[b.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + w[0].length }, this.yytext += w[0], this.match += w[0], this.matches = w, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(w[0].length), this.matched += w[0], L = this.performAction.call(this, this.yy, this, k, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), L) return L;
      if (this._backtrack) {
      ...
      for (var M = this._currentRules(), h = 0; h < M.length; h++) if (L = this._input.match(this.rules[M[h]]), L && (!k || L[0].length > k[0].length)) {
        if (k = L, b = h, this.options.backtrack_lexer) {
          if (w = this.test_match(L, M[h]), w !== false) return w;
          if (this._backtrack) {
            k = false;
            continue;
          } else return false;
      ...
      return k ? (w = this.test_match(k, M[b]), w !== false ? w : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var k = this.next();
      return k || this.lex();
    ...
    }, options: { "case-insensitive": true }, performAction: function(k, L, b, M) {
      switch (b) {
        case 0:
          return 5;
        case 1:
...
const E = new Ve(() => ({ prevActor: void 0, actors: {}, createdActors: {}, destroyedActors: {}, boxes: [], messages: [], notes: [], sequenceNumbersEnabled: false, wrapEnabled: void 0, currentBox: void 0, lastCreated: void 0, lastDestroyed: void 0 })), Oe = function(t) {
  E.records.boxes.push({ name: t.text, wrap: t.wrap === void 0 && gt() || !!t.wrap, fill: t.color, actorKeys: [] }), E.records.currentBox = E.records.boxes.slice(-1)[0];
}, Ft = function(t, e, o, s) {
  let i = E.records.currentBox;
  const a = E.records.actors[t];
  if (a) {
    if (E.records.currentBox && a.box && E.records.currentBox !== a.box) throw new Error("A same participant should only be defined in one Box: " + a.name + " can't be in '" + a.box.name + "' and in '" + E.records.currentBox.name + "' at the same time.");
    if (i = a.box ? a.box : E.records.currentBox, a.box = i, a && e === a.name && o == null) return;
  }
  (o == null || o.text == null) && (o = { text: e, wrap: null, type: s }), (s == null || o.text == null) && (o = { text: e, wrap: null, type: s }), E.records.actors[t] = { box: i, name: e, description: o.text, wrap: o.wrap === void 0 && gt() || !!o.wrap, prevActor: E.records.prevActor, links: {}, properties: {}, actorCnt: null, rectData: null, type: s || "participant" }, E.records.prevActor && E.records.actors[E.records.prevActor] && (E.records.actors[E.records.prevActor].nextActor = t), E.records.currentBox && E.records.currentBox.actorKeys.push(t), E.records.prevActor = t;
}, Be = (t) => {
  let e, o = 0;
  for (e = 0; e < E.records.messages.length; e++) E.records.messages[e].type === mt.ACTIVE_START && E.records.messages[e].from.actor === t && o++, E.records.messages[e].type === mt.ACTIVE_END && E.records.messages[e].from.actor === t && o--;
  return o;
}, Ye = function(t, e, o, s) {
  E.records.messages.push({ from: t, to: e, message: o.text, wrap: o.wrap === void 0 && gt() || !!o.wrap, answer: s });
}, C = function(t, e, o = { text: void 0, wrap: void 0 }, s, i = false) {
  ...
  return E.records.messages.push({ from: t, to: e, message: o.text, wrap: o.wrap === void 0 && gt() || !!o.wrap, type: s, activate: i }), true;
}, Fe = function() {
  ...
  const e = t.trim(), o = { text: e.replace(/^:?(?:no)?wrap:/, "").trim(), wrap: e.match(/^:?wrap:/) !== null ? true : e.match(/^:?nowrap:/) !== null ? false : void 0 };
  return X.debug("parseMessage:", o), o;
}, t0 = function(t) {
  const e = t.match(/^((?:rgba?|hsla?)\s*\(.*\)|\w*)(.*)$/);
  let o = e != null && e[1] ? e[1].trim() : "transparent", s = e != null && e[2] ? e[2].trim() : void 0;
  if (window && window.CSS) window.CSS.supports("color", o) || (o = "transparent", s = t.trim());
  else {
    const i = new Option().style;
    i.color = o, i.color !== o && (o = "transparent", s = t.trim());
  }
  return { color: o, text: s !== void 0 ? At(s.replace(/^:?(?:no)?wrap:/, ""), st()) : void 0, wrap: s !== void 0 ? s.match(/^:?wrap:/) !== null ? true : s.match(/^:?nowrap:/) !== null ? false : void 0 : void 0 };
}, mt = { SOLID: 0, DOTTED: 1, NOTE: 2, SOLID_CROSS: 3, DOTTED_CROSS: 4, SOLID_OPEN: 5, DOTTED_OPEN: 6, LOOP_START: 10, LOOP_END: 11, ALT_START: 12, ALT_ELSE: 13, ALT_END: 14, OPT_START: 15, OPT_END: 16, ACTIVE_START: 17, ACTIVE_END: 18, PAR_START: 19, PAR_AND: 20, PAR_END: 21, RECT_START: 22, RECT_END: 23, SOLID_POINT: 24, DOTTED_POINT: 25, AUTONUMBER: 26, CRITICAL_START: 27, CRITICAL_OPTION: 28, CRITICAL_END: 29, BREAK_START: 30, BREAK_END: 31, PAR_OVER_START: 32 }, e0 = { FILLED: 0, OPEN: 1 }, s0 = { LEFTOF: 0, RIGHTOF: 1, OVER: 2 }, re = function(t, e, o) {
  const s = { actor: t, placement: e, message: o.text, wrap: o.wrap === void 0 && gt() || !!o.wrap }, i = [].concat(t, t);
  E.records.notes.push(s), E.records.messages.push({ from: i[0], to: i[1], message: o.text, wrap: o.wrap === void 0 && gt() || !!o.wrap, type: mt.NOTE, placement: e });
}, ie = function(t, e) {
  const o = vt(t);
  try {
    let s = At(e.text, st());
...
const oe = function(t, e) {
  ...
  if (Array.isArray(t)) t.forEach(function(e) {
    ...
    case "sequenceIndex":
      E.records.messages.push({ from: void 0, to: void 0, message: { start: t.sequenceIndex, step: t.sequenceIndexStep, visible: t.sequenceVisible }, wrap: false, type: t.signalType });
      break;
    case "addParticipant":
      Ft(t.actor, t.actor, t.description, t.draw);
      break;
    case "createParticipant":
      if (E.records.actors[t.actor]) throw new Error("It is not possible to have actors with the same id, even if one is destroyed before the next is created. Use 'AS' aliases to simulate the behavior");
    ...
    case "addMessage":
      if (E.records.lastCreated) {
        if (t.to !== E.records.lastCreated) throw new Error("The created participant " + E.records.lastCreated + " does not have an associated creating message after its declaration. Please check the sequence diagram.");
        E.records.lastCreated = void 0;
      } else if (E.records.lastDestroyed) {
        if (t.to !== E.records.lastDestroyed && t.from !== E.records.lastDestroyed) throw new Error("The destroyed participant " + E.records.lastDestroyed + " does not have an associated destroying message after its declaration. Please check the sequence diagram.");
...
`, o0 = n0, ft = 18 * 2, le = "actor-top", he = "actor-bottom", Ut = function(t, e) {
  ...
  if (e.links === void 0 || e.links === null || Object.keys(e.links).length === 0) return { height: 0, width: 0 };
  ...
  if (u.attr("class", "actorPopupMenuPanel" + x), u.attr("x", l.x), u.attr("y", l.height), u.attr("fill", l.fill), u.attr("stroke", l.stroke), u.attr("width", T), u.attr("height", l.height), u.attr("rx", l.rx), u.attr("ry", l.ry), a != null) {
    ...
    for (let I in a) {
      ...
      m.attr("xlink:href", _), m.attr("target", "_blank"), k0(s)(I, m, l.x + 10, l.height + g, T, 20, { class: "actor" }, s), g += 30;
    }
  }
  ...
  if (e.valign !== void 0 && e.textMargin !== void 0 && e.textMargin > 0) switch (e.valign) {
    ...
    case "bottom":
    case "end":
      r = () => Math.round(e.y + (o + s + 2 * e.textMargin) - e.textMargin);
      break;
  }
...
const pe = (t, e, o, s) => {
  ...
  await Kt(o, nt(e.description))(e.description, p, r.x, r.y, r.width, r.height, { class: "actor" }, o);
  let u = e.height;
  if (T.node) {
  ...
  return e.height = T.height, await Kt(o, nt(e.description))(e.description, l, r.x, r.y + 35, r.width, r.height, { class: "actor" }, o), e.height;
  ...
  const i = t.append("g");
  ue(i, e), e.name && await Kt(o)(e.name, i, e.x, e.y + (e.textMaxHeight || 0) / 2, e.width, 0, { class: "text" }, o), i.lower();
}, f0 = function(t) {
  return t.append("g");
  ...
  const { boxMargin: i, boxTextMargin: a, labelBoxHeight: c, labelBoxWidth: l, messageFontFamily: p, messageFontSize: r, messageFontWeight: x } = s, T = t.append("g"), u = function(_, I, V, S) {
  ...
  let g = zt();
  g.text = o, g.x = e.startx, g.y = e.starty, g.fontFamily = p, g.fontSize = r, g.fontWeight = x, g.anchor = "middle", g.valign = "middle", g.tspan = false, g.width = l || 50, g.height = c || 20, g.textMargin = a, g.class = "labelText", de(T, g), g = fe(), g.text = e.title, g.x = e.startx + l / 2 + (e.stopx - e.startx) / 2, g.y = e.starty + i + a, g.anchor = "middle", g.valign = "middle", g.textMargin = a, g.class = "loopText", g.fontFamily = p, g.fontSize = r, g.fontWeight = x, g.wrap = true;
  let m = nt(g.text) ? await It(T, g, e) : bt(T, g);
  if (e.sectionTitles !== void 0) {
    for (const [_, I] of Object.entries(e.sectionTitles)) if (I.message) {
      g.text = I.message, g.x = e.startx + (e.stopx - e.startx) / 2, g.y = e.sections[_].y + i + a, g.class = "loopText", g.anchor = "middle", g.valign = "middle", g.tspan = false, g.fontFamily = p, g.fontSize = r, g.fontWeight = x, g.wrap = e.wrap, nt(g.text) ? (e.starty = e.sections[_].y, await It(T, g, e)) : bt(T, g);
      let V = Math.round(m.map((S) => (S._groups || S)[0][0].getBBox().height).reduce((S, O) => S + O));
  ...
  function i(a, c) {
    for (const l in c) c.hasOwnProperty(l) && a.attr(l, c[l]);
  }
  return function(a, c = false) {
  ...
  function s(i, a) {
    for (const c in a) a.hasOwnProperty(c) && i.attr(c, a[c]);
  }
  return function(i) {
    return i.textPlacement === "fo" ? o : i.textPlacement === "old" ? t : e;
  };
}(), D = { drawRect: Ut, drawText: bt, drawLabel: de, drawActor: p0, drawBox: u0, drawPopup: c0, anchorElement: f0, drawActivation: g0, drawLoop: x0, drawBackgroundRect: ue, insertArrowHead: E0, insertArrowFilledHead: m0, insertSequenceNumber: w0, insertArrowCrossHead: v0, insertDatabaseIcon: y0, insertComputerIcon: T0, insertClockIcon: b0, getTextObj: fe, getNoteRect: _0, fixLifeLineHeights: pe, sanitizeUrl: se.sanitizeUrl };
let n = {};
const f = { data: { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, verticalPos: 0, sequenceItems: [], activations: [], models: { getHeight: function() {
  ...
  this.sequenceItems = [], this.activations = [], this.models.clear(), this.data = { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, this.verticalPos = 0, xe(st());
  ...
  this.activations.push({ startx: a, starty: this.verticalPos + 2, stopx: a + n.activationWidth, stopy: void 0, actor: t.from.actor, anchored: D.anchorElement(e) });
  ...
  const c = nt(a.text) ? await It(s, a) : bt(s, a), l = Math.round(c.map((p) => (p._groups || p)[0][0].getBBox().height).reduce((p, r) => p + r));
...
}, xt = (t) => ({ fontFamily: t.messageFontFamily, fontSize: t.messageFontSize, fontWeight: t.messageFontWeight }), Tt = (t) => ({ fontFamily: t.noteFontFamily, fontSize: t.noteFontSize, fontWeight: t.noteFontWeight }), Wt = (t) => ({ fontFamily: t.actorFontFamily, fontSize: t.actorFontSize, fontWeight: t.actorFontWeight });
async function L0(t, e) {
  ...
  if (o === s) {
    ...
    f.insert(o - T, f.getVerticalPos() - 10 + r, s + T, f.getVerticalPos() + 30 + r);
  } else r += n.boxMargin, p = f.getVerticalPos() + r, f.insert(o, p - 10, s, p);
...
const I0 = async function(t, e, o, s) {
  ...
  if (s) {
    ...
    for (const a of o) {
      ...
      const l = await D.drawActor(t, c, n, true);
      i = v.getMax(i, l);
    }
    f.bumpVerticalPos(i + n.boxMargin);
  } else for (const i of o) {
    const a = e[i];
    await D.drawActor(t, a, n, false);
  }
}, ge = function(t, e, o, s) {
  let i = 0, a = 0;
  for (const c of o) {
    const l = e[c], p = R0(l), r = D.drawPopup(t, l, p, n, n.forceMenus, s);
...
function it(t, e, o, s, i) {
  ...
  if (e.id && e.message && t[e.id]) {
    ...
    e.message = B.wrapLabel(`[${e.message}]`, c - 2 * n.wrapPadding, l), e.width = c, e.wrap = true;
...
function N0(t, e, o, s, i, a, c) {
  function l(r, x) {
    r.x < i[t.from].x ? (f.insert(e.stopx - x, e.starty, e.startx, e.stopy + r.height / 2 + n.noteMargin), e.stopx = e.stopx + x) : (f.insert(e.startx, e.starty, e.stopx + x, e.stopy + r.height / 2 + n.noteMargin), e.stopx = e.stopx - x);
  }
  function p(r, x) {
    r.x < i[t.to].x ? (f.insert(e.startx - x, e.starty, e.stopx, e.stopy + r.height / 2 + n.noteMargin), e.startx = e.startx + x) : (f.insert(e.stopx, e.starty, e.startx + x, e.stopy + r.height / 2 + n.noteMargin), e.startx = e.startx - x);
  }
  if (a[t.to] == s) {
...
const S0 = async function(t, e, o, s) {
  ...
  if (n.height = await C0(x, O, g), D.insertComputerIcon(r), D.insertDatabaseIcon(r), D.insertClockIcon(r), V && (f.bumpVerticalPos(n.boxMargin), S && f.bumpVerticalPos(g[0].textMaxHeight)), n.hideUnusedParticipants === true) {
  ...
  function q(y, P) {
    ...
    j.starty + 18 > P && (j.starty = P - 6, P += 12), D.drawActivation(r, j, P, n, St(y.from.actor).length), f.insert(j.startx, P - 10, j.stopx, P);
  }
  let z = 1, J = 1;
  const $ = [], H = [];
  let U = 0;
  for (const y of _) {
    ...
    switch (y.type) {
      ...
      case s.db.LINETYPE.LOOP_START:
        it(R, y, n.boxMargin, n.boxMargin + n.boxTextMargin, (A) => f.newLoop(A));
        break;
      ...
      case s.db.LINETYPE.RECT_START:
        it(R, y, n.boxMargin, n.boxMargin, (A) => f.newLoop(void 0, A.message));
        break;
      ...
      case s.db.LINETYPE.ALT_ELSE:
        it(R, y, n.boxMargin + n.boxTextMargin, n.boxMargin, (A) => f.addSectionToLoop(A));
        break;
      ...
      case s.db.LINETYPE.PAR_OVER_START:
        it(R, y, n.boxMargin, n.boxMargin + n.boxTextMargin, (A) => f.newLoop(A)), f.saveVerticalPos();
        break;
      ...
      default:
        try {
          ...
          N0(y, rt, A, U, x, T, u), $.push({ messageModel: rt, lineStartY: A }), f.models.addMessage(rt);
        } catch (A) {
          X.error("error while drawing message", A);
        }
    }
    [s.db.LINETYPE.SOLID_OPEN, s.db.LINETYPE.DOTTED_OPEN, s.db.LINETYPE.SOLID, s.db.LINETYPE.DOTTED, s.db.LINETYPE.SOLID_CROSS, s.db.LINETYPE.DOTTED_CROSS, s.db.LINETYPE.SOLID_POINT, s.db.LINETYPE.DOTTED_POINT].includes(y.type) && (z = z + J), U++;
  }
  X.debug("createdActors", T), X.debug("destroyedActors", u), await qt(r, x, m, false);
  for (const y of $) await I0(r, y.messageModel, y.lineStartY, s);
  n.mirrorActors && await qt(r, x, m, true), H.forEach((y) => D.drawBackgroundRect(r, y)), pe(r, x, m, n);
  for (const y of f.models.boxes) y.height = f.getVerticalPos() - y.y, f.insert(y.x, y.y, y.x + y.width, y.height), y.startx = y.x, y.starty = y.y, y.stopx = y.startx + y.width, y.stopy = y.starty + y.height, y.stroke = "rgb(0,0,0, 0.5)", await D.drawBox(r, y, n);
  ...
  const N = I ? 40 : 0;
  r.attr("viewBox", W.startx - n.diagramMarginX + " -" + (n.diagramMarginY + N) + " " + tt + " " + (K + N)), X.debug("models:", f.models);
};
async function M0(t, e, o) {
  const s = {};
  for (const i of e) if (t[i.to] && t[i.from]) {
    const a = t[i.to];
    if (i.placement === o.db.PLACEMENT.LEFTOF && !a.prevActor || i.placement === o.db.PLACEMENT.RIGHTOF && !a.nextActor) continue;
    ...
    l && i.from === a.nextActor ? s[i.to] = v.getMax(s[i.to] || 0, T) : l && i.from === a.prevActor ? s[i.from] = v.getMax(s[i.from] || 0, T) : l && i.from === i.to ? (s[i.from] = v.getMax(s[i.from] || 0, T / 2), s[i.to] = v.getMax(s[i.to] || 0, T / 2)) : i.placement === o.db.PLACEMENT.RIGHTOF ? s[i.from] = v.getMax(s[i.from] || 0, T) : i.placement === o.db.PLACEMENT.LEFTOF ? s[a.prevActor] = v.getMax(s[a.prevActor] || 0, T) : i.placement === o.db.PLACEMENT.OVER && (a.prevActor && (s[a.prevActor] = v.getMax(s[a.prevActor] || 0, T / 2)), a.nextActor && (s[i.from] = v.getMax(s[i.from] || 0, T / 2)));
  }
...
async function C0(t, e, o) {
  ...
  for (const a of Object.keys(t)) {
    const c = t[a];
    c.wrap && (c.description = B.wrapLabel(c.description, n.width - 2 * n.wrapPadding, Wt(n)));
...
const D0 = async function(t, e, o) {
  ...
  t.wrap && t.message && (t.message = B.wrapLabel(t.message, v.getMax(g + 2 * n.wrapPadding, n.width), xt(n)));
  const m = B.calculateTextDimensions(t.message, xt(n));
  return { width: v.getMax(t.wrap ? 0 : m.width + 2 * n.wrapPadding, g + 2 * n.wrapPadding, n.width), height: 0, startx: p, stopx: r, starty: 0, stopy: 0, message: t.message, type: t.type, wrap: t.wrap, fromBounds: Math.min.apply(null, u), toBounds: Math.max.apply(null, u) };
  ...
  for (const r of t) {
    switch (r.id = B.random({ length: 10 }), r.type) {
      ...
      case s.db.LINETYPE.CRITICAL_START:
      case s.db.LINETYPE.BREAK_START:
        a.push({ id: r.id, msg: r.message, from: Number.MAX_SAFE_INTEGER, to: Number.MIN_SAFE_INTEGER, width: 0 });
        break;
      case s.db.LINETYPE.ALT_ELSE:
      case s.db.LINETYPE.PAR_AND:
      case s.db.LINETYPE.CRITICAL_OPTION:
      ...
      case s.db.LINETYPE.ACTIVE_START:
        {
          const T = e[r.from ? r.from.actor : r.to.actor], u = St(r.from ? r.from.actor : r.to.actor).length, g = T.x + T.width / 2 + (u - 1) * n.activationWidth / 2, m = { startx: g, stopx: g + n.activationWidth, actor: r.from.actor, enabled: true };
    ...
    r.placement !== void 0 ? (l = await D0(r, e, s), r.noteModel = l, a.forEach((T) => {
      ...
      if (c = T, p.startx === p.stopx) {
        ...
        c.from = v.getMin(u.x - p.width / 2, u.x - u.width / 2, c.from), c.to = v.getMax(g.x + p.width / 2, g.x + u.width / 2, c.to), c.width = v.getMax(c.width, Math.abs(c.to - c.from)) - n.labelBoxWidth;
      } else c.from = v.getMin(p.startx, c.from), c.to = v.getMax(p.stopx, c.to), c.width = v.getMax(c.width, p.width) - n.labelBoxWidth;
    }));
  }
  return f.activations = [], X.debug("Loop type widths:", i), i;
}, B0 = { bounds: f, drawActors: qt, drawActorsPopup: ge, setConf: xe, draw: S0 }, z0 = { parser: De, db: Qt, renderer: B0, styles: o0, init: ({ wrap: t }) => {
  Qt.setWrap(t);
} };
export {
  z0 as diagram

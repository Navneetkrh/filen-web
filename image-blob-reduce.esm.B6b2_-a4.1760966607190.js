...
var J = N, $ = V, W = { assign: K, pick: J, pick_pica_resize_options: $ };
function q(A) {
  var I = { exports: {} };
...
var X = q(function(A, I) {
  (function(d) {
    ...
    return (/* @__PURE__ */ function() {
      ...
      function e(i) {
        var a = i || [], n = { js: a.indexOf("js") >= 0, wasm: a.indexOf("wasm") >= 0 };
        c.call(this, n), this.features = { js: n.js, wasm: n.wasm && this.has_wasm() }, this.use(r), this.use(t);
      }
      ...
      function c(t, e, i, a, n, s) {
        ...
        for (F = 0; F < a; F++) {
          for (m = 0, O = 0; O < n; O++) {
            for (b = s[m++], B = s[m++], C = k + b * 4 | 0, f = u = l = y = 0; B > 0; B--) E = s[m++], y = y + E * t[C + 3] | 0, l = l + E * t[C + 2] | 0, u = u + E * t[C + 1] | 0, f = f + E * t[C] | 0, C = C + 4 | 0;
            e[R + 3] = g(y + 8192 >> 14), e[R + 2] = g(l + 8192 >> 14), e[R + 1] = g(u + 8192 >> 14), e[R] = g(f + 8192 >> 14), R = R + a * 4 | 0;
          }
      ...
      h.exports = { name: "resize", fn: d("./resize"), wasm_fn: d("./resize_wasm"), wasm_src: d("./convolve_wasm_base64") };
      ...
      h.exports = function(i) {
        var a = i.src, n = i.width, s = i.height, f = i.toWidth, u = i.toHeight, l = i.scaleX || i.toWidth / i.width, y = i.scaleY || i.toHeight / i.height, m = i.offsetX || 0, b = i.offsetY || 0, B = i.dest || new Uint8Array(f * u * 4), C = typeof i.quality > "u" ? 3 : i.quality, F = i.alpha || false, O = g(C, n, f, l, m), E = g(C, s, u, y, b), k = new Uint8Array(f * s * 4);
      ...
      h.exports = function(e, i, a, n, s) {
        ...
        for (m = 0; m < a; m++) {
          for (b = (m + 0.5) * u + s, B = Math.max(0, Math.floor(b - y)), C = Math.min(i - 1, Math.ceil(b + y)), F = C - B + 1, O = new Float32Array(F), E = new Int16Array(F), k = 0, R = B, D = 0; R <= C; R++, D++) S = f((R + 0.5 - b) * l), k += S, O[D] = S;
          for (j = 0, D = 0; D < O.length; D++) G = O[D] / k, j += G, E[D] = r(G);
          for (E[a >> 1] += r(1 - j), o = 0; o < E.length && E[o] === 0; ) o++;
          if (o < E.length) {
            for (p = E.length - 1; p > 0 && E[p] === 0; ) p--;
            if (_ = B + o, v = p - o + 1, U[Q++] = _, U[Q++] = v, !M) U.set(E.subarray(o, p + 1), Q), Q += v;
      ...
      h.exports = { name: "unsharp_mask", fn: d("./unsharp_mask"), wasm_fn: d("./unsharp_mask_wasm"), wasm_src: d("./unsharp_mask_wasm_base64") };
    }, { "./unsharp_mask": 10, "./unsharp_mask_wasm": 11, "./unsharp_mask_wasm_base64": 12 }], 10: [function(d, h, x) {
      var g = d("glur/mono16");
      function c(r, t, e) {
        for (var i = t * e, a = new Uint16Array(i), n, s, f, u, l = 0; l < i; l++) n = r[4 * l], s = r[4 * l + 1], f = r[4 * l + 2], u = n >= s && n >= f ? n : s >= f && s >= n ? s : f, a[l] = u << 8;
        return a;
      }
      h.exports = function(t, e, i, a, n, s) {
        ...
        if (!(a === 0 || n < 0.5)) {
          ...
          g(B, e, i, n);
          for (var C = a / 100 * 4096 + 0.5 | 0, F = s << 8, O = e * i, E = 0; E < O; E++) f = b[E], y = f - B[E], Math.abs(y) >= F && (u = f + (C * y + 2048 >> 12), u = u > 65280 ? 65280 : u, u = u < 0 ? 0 : u, f = f !== 0 ? f : 1, l = (u << 12) / f | 0, m = E * 4, t[m] = t[m] * l + 2048 >> 12, t[m + 1] = t[m + 1] * l + 2048 >> 12, t[m + 2] = t[m + 2] * l + 2048 >> 12);
        }
      };
      ...
      h.exports = function(c, r, t, e, i, a) {
        if (!(e === 0 || i < 0.5)) {
          i > 2 && (i = 2);
          var n = r * t, s = n * 4, f = n * 2, u = n * 2, l = Math.max(r, t) * 4, y = 8 * 4, m = 0, b = s, B = b + f, C = B + u, F = C + u, O = F + l, E = this.__instance("unsharp_mask", s + f + u * 2 + l + y, { exp: Math.exp }), k = new Uint32Array(c.buffer), R = new Uint32Array(this.__memory.buffer);
          R.set(k);
      ...
      c.prototype.acquire = function() {
        ...
        this.available = this.available.filter(function(e) {
          return t - e.lastUsed > r.idle ? (e.destroy(), false) : true;
      ...
      h.exports.isCanvas = function(r) {
        ...
        return Promise.resolve().then(function() {
          ...
          var t = r(100, 100);
          return createImageBitmap(t, 0, 0, 100, 100, { resizeWidth: 10, resizeHeight: 10, resizeQuality: "high" }).then(function(e) {
            var i = e.width === 10;
        ...
        return new Promise(function(r, t) {
          ...
          function e(n) {
            ...
            Promise.resolve().then(function() {
              ...
              return n.postMessage(true);
            }, function() {
              return n.postMessage(false);
            });
          }
        ...
        try {
          ...
          a.data[0] = 12, a.data[1] = 23, a.data[2] = 34, a.data[3] = 255, a.data[4] = 45, a.data[5] = 56, a.data[6] = 67, a.data[7] = 255, i.putImageData(a, 0, 0), a = null, a = i.getImageData(0, 0, 2, 1), a.data[0] === 12 && a.data[1] === 23 && a.data[2] === 34 && a.data[3] === 255 && a.data[4] === 45 && a.data[5] === 56 && a.data[6] === 67 && a.data[7] === 255 && (t = true);
        } catch {
        }
        return t;
        ...
        return new Promise(function(r) {
          ...
          t.src = "data:image/jpeg;base64,", t.onload = function() {
            createImageBitmap(t, 0, 0, t.width, t.height).then(function(e) {
              e.width === t.width && e.height === t.height ? r(true) : r(false);
            }, function() {
              return r(false);
            });
          }, t.onerror = function() {
      ...
      h.exports = function() {
        ...
        onmessage = function(t) {
          var e = t.data.opts, i = false;
          if (!e.src && e.srcBitmap) {
            var a = new OffscreenCanvas(e.width, e.height), n = a.getContext("2d", { alpha: !!e.alpha });
            n.drawImage(e.srcBitmap, 0, 0), e.src = n.getImageData(0, 0, e.width, e.height).data, a.width = a.height = 0, a = null, e.srcBitmap.close(), e.srcBitmap = null, i = true;
          }
          c || (c = new g(t.data.features));
          var s = c.resizeAndUnsharp(e);
          if (i) {
            var f = new ImageData(new Uint8ClampedArray(s), e.toWidth, e.toHeight), u = new OffscreenCanvas(e.toWidth, e.toHeight), l = u.getContext("2d", { alpha: !!e.alpha });
      ...
      function f(l, y, m, b, B, C) {
        ...
        for (G = 0; G < C; G++) {
          for (D = G * B, S = G, j = 0, F = l[D], R = F * b[6], k = R, p = b[0], _ = b[1], v = b[4], w = b[5], o = 0; o < B; o++) O = l[D], E = O * p + F * _ + k * v + R * w, R = k, k = E, F = O, m[j] = k, j++, D++;
          for (D--, j--, S += C * (B - 1), F = l[D], R = F * b[7], k = R, O = F, p = b[2], _ = b[3], o = B - 1; o >= 0; o--) E = O * p + F * _ + k * v + R * w, R = k, k = E, F = O, O = l[D], y[S] = m[j] + k, D--, j--, S -= C;
        }
      }
      function u(l, y, m, b) {
        if (b) {
      ...
      typeof Object.create == "function" ? h.exports = function(c, r) {
        r && (c.super_ = r, c.prototype = Object.create(r.prototype, { constructor: { value: c, enumerable: false, writable: true, configurable: true } }));
      ...
      var g = d("object-assign"), c = d("./lib/base64decode"), r = d("./lib/wa_detect"), t = { js: true, wasm: true };
      function e(i) {
        if (!(this instanceof e)) return new e(i);
        var a = g({}, t, i || {});
        if (this.options = a, this.__cache = {}, this.__init_promise = null, this.__modules = a.modules || {}, this.__memory = null, this.__wasm = {}, this.__isLE = new Uint32Array(new Uint8Array([1, 0, 0, 0]).buffer)[0] === 1, !this.options.js && !this.options.wasm) throw new Error('mathlib: at least "js" or "wasm" should be enabled');
      }
      e.prototype.has_wasm = r, e.prototype.use = function(i) {
        ...
        if (!this.__memory) return this.__memory = new WebAssembly.Memory({ initial: Math.ceil(a / (64 * 1024)) }), this.__memory;
        ...
        if (!this.__cache[a]) {
          var u = { memoryBase: 0, memory: this.__memory, tableBase: 0, table: new WebAssembly.Table({ initial: 0, element: "anyfunc" }) };
          this.__cache[a] = new WebAssembly.Instance(this.__wasm[a], { env: g(u, s || {}) });
        }
      ...
      h.exports = function(r) {
        for (var t = r.replace(/[\r\n=]/g, ""), e = t.length, i = new Uint8Array(e * 3 >> 2), a = 0, n = 0, s = 0; s < e; s++) s % 4 === 0 && s && (i[n++] = a >> 16 & 255, i[n++] = a >> 8 & 255, i[n++] = a & 255), a = a << 6 | g.indexOf(t.charAt(s));
        var f = e % 4 * 6;
      ...
      var g;
      h.exports = function() {
        if (typeof g < "u" || (g = false, typeof WebAssembly > "u")) return g;
        try {
          ...
          return e.exports.test(4) !== 0 && (g = true), g;
        } catch {
        }
        return g;
      };
      ...
      h.exports = function(e, i) {
        ...
        b[a] = a, c[m] = ["function(require,module,exports){var f = require(" + t(a) + ");(f.default ? f.default : f)(self);}", b];
        var B = {};
        C(m);
        function C(D) {
          B[D] = true;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      function e(o, p) {
        ...
        if (_ != null) {
          var v = [], w = true, U = false, Q, M;
          try {
            for (_ = _.call(o); !(w = (Q = _.next()).done) && (v.push(Q.value), !(p && v.length === p)); w = true) ;
          } catch (P) {
            U = true, M = P;
          } finally {
            try {
      ...
      var a = d("object-assign"), n = d("webworkify"), s = d("./lib/mathlib"), f = d("./lib/pool"), u = d("./lib/utils"), l = d("./lib/worker"), y = d("./lib/stepper"), m = d("./lib/tiler"), b = {}, B = false;
      try {
      ...
      var F = { tile: 1024, concurrency: C, features: ["js", "wasm", "ww"], idle: 2e3, createCanvas: function(p, _) {
        var v = document.createElement("canvas");
        return v.width = p, v.height = _, v;
      } }, O = { quality: 3, alpha: false, unsharpAmount: 0, unsharpRadius: 0, unsharpThreshold: 0 }, E = false, k = false, R = false, D = false, S = false;
      function j() {
        return { value: n(l), destroy: function() {
      ...
      function G(o) {
        ...
        this.__limit = b[p] || u.limiter(this.options.concurrency), b[p] || (b[p] = this.__limit), this.features = { js: false, wasm: false, cib: false, ww: false }, this.__workersPool = null, this.__requested_features = [], this.__mathlib = null;
      }
      G.prototype.init = function() {
        ...
        typeof ImageBitmap < "u" && (ImageBitmap.prototype && ImageBitmap.prototype.close ? k = true : this.debug("ImageBitmap does not support .close(), disabled"));
        var p = this.options.features.slice();
        if (p.indexOf("all") >= 0 && (p = ["cib", "wasm", "js", "ww"]), this.__requested_features = p, this.__mathlib = new s(p), p.indexOf("ww") >= 0 && typeof window < "u" && "Worker" in window) try {
          var _ = d("webworkify")(function() {
          });
          _.terminate(), this.features.ww = true;
        ...
        }) : U = Promise.resolve(false), R = u.can_use_canvas(this.options.createCanvas);
        var Q;
        k && E && p.indexOf("ww") !== -1 ? Q = u.worker_offscreen_canvas_support() : Q = Promise.resolve(false), Q = Q.then(function(P) {
          D = P;
        });
        ...
        return p.__mathCache = p.__mathCache || {}, Promise.resolve().then(function() {
          return _.features.ww ? new Promise(function(v, w) {
            ...
            var Q = [];
            o.src && Q.push(o.src.buffer), o.srcBitmap && Q.push(o.srcBitmap), U.value.postMessage({ opts: o, features: _.__requested_features, preload: { wasm_nodule: _.__mathlib.__ } }, Q);
          }) : { data: _.__mathlib.resizeAndUnsharp(o, p.__mathCache) };
        });
      }, G.prototype.__extractTileData = function(o, p, _, v, w) {
        if (this.features.ww && D && (u.isCanvas(p) || S)) return this.debug("Create tile for OffscreenCanvas"), createImageBitmap(v.srcImageBitmap || p, o.x, o.y, o.width, o.height).then(function(M) {
          return w.srcBitmap = M, w;
        });
        if (u.isCanvas(p)) return v.srcCtx || (v.srcCtx = p.getContext("2d", { alpha: !!_.alpha })), this.debug("Get tile pixel data"), w.src = v.srcCtx.getImageData(o.x, o.y, o.width, o.height).data, w;
        this.debug("Draw tile imageBitmap/image to temporary canvas");
        var U = this.options.createCanvas(o.width, o.height), Q = U.getContext("2d", { alpha: !!_.alpha });
        ...
        var v;
        if (this.debug("Convert raw rgba tile result to ImageData"), p.bitmap) return _.toCtx.drawImage(p.bitmap, o.toX, o.toY), null;
        if (E) v = new ImageData(new Uint8ClampedArray(p.data), o.toWidth, o.toHeight);
        else if (v = _.toCtx.createImageData(o.toWidth, o.toHeight), v.data.set) v.data.set(p.data);
        ...
        var v = this, w = { srcCtx: null, srcImageBitmap: null, isImageBitmapReused: false, toCtx: null }, U = function(M) {
          return v.__limit(function() {
            if (_.canceled) return _.cancelToken;
            var P = { width: M.width, height: M.height, toWidth: M.toWidth, toHeight: M.toHeight, scaleX: M.scaleX, scaleY: M.scaleY, offsetX: M.offsetX, offsetY: M.offsetY, quality: _.quality, alpha: _.alpha, unsharpAmount: _.unsharpAmount, unsharpRadius: _.unsharpRadius, unsharpThreshold: _.unsharpThreshold };
        ...
        return Promise.resolve().then(function() {
          if (w.toCtx = p.getContext("2d", { alpha: !!_.alpha }), u.isCanvas(o)) return null;
          if (u.isImageBitmap(o)) return w.srcImageBitmap = o, w.isImageBitmapReused = true, null;
          if (u.isImage(o)) return k ? (v.debug("Decode image via createImageBitmap"), createImageBitmap(o).then(function(Q) {
            w.srcImageBitmap = Q;
          }).catch(function(Q) {
            return null;
          })) : null;
          ...
          var Q = m({ width: _.width, height: _.height, srcTileSize: v.options.tile, toWidth: _.toWidth, toHeight: _.toHeight, destTileBorder: _.__destTileBorder }), M = Q.map(function(T) {
            return U(T);
          });
          function P(T) {
        ...
        v = a({}, v, { toWidth: M, toHeight: P, quality: T ? v.quality : Math.min(1, v.quality) });
        var z;
        ...
        var v = this, w = p.getContext("2d", { alpha: !!_.alpha });
        return this.debug("Resize via createImageBitmap()"), createImageBitmap(o, { resizeWidth: _.toWidth, resizeHeight: _.toHeight, resizeQuality: u.cib_quality_name(_.quality) }).then(function(U) {
          if (_.canceled) return _.cancelToken;
          if (!_.unsharpAmount) return w.drawImage(U, 0, 0), U.close(), w = null, v.debug("Finished!"), p;
          v.debug("Unsharp result");
          var Q = v.options.createCanvas(_.toWidth, _.toHeight), M = Q.getContext("2d", { alpha: !!_.alpha });
        ...
        var w = a({}, O);
        if (isNaN(_) ? _ && (w = a(w, _)) : w = a(w, { quality: _ }), w.toWidth = p.width, w.toHeight = p.height, w.width = o.naturalWidth || o.width, w.height = o.naturalHeight || o.height, p.width === 0 || p.height === 0) return Promise.reject(new Error("Invalid output size: ".concat(p.width, "x").concat(p.height)));
        w.unsharpRadius > 2 && (w.unsharpRadius = 2), w.canceled = false, w.cancelToken && (w.cancelToken = w.cancelToken.then(function(Q) {
          throw w.canceled = true, Q;
        }, function(Q) {
          throw w.canceled = true, Q;
        }));
        var U = 3;
        ...
        return p = p || "image/png", new Promise(function(v) {
          ...
          for (var w = atob(o.toDataURL(p, _).split(",")[1]), U = w.length, Q = new Uint8Array(U), M = 0; M < U; M++) Q[M] = w.charCodeAt(M);
          v(new Blob([Q], { type: p }));
        });
  ...
  c.prototype.each = function(r) {
    ...
    for (this.ifds_to_read = [{ id: 0, offset: t }]; this.ifds_to_read.length > 0 && !this.aborted; ) {
    ...
    t.ifd0 = { id: 0, entries: [] }, this.each(function(n) {
      r(n) === false && !n.is_subifd_link || n.is_subifd_link && n.count !== 1 && n.format !== 4 || (t["ifd" + n.ifd] || (t["ifd" + n.ifd] = { id: n.ifd, entries: [] }), t["ifd" + n.ifd].entries.push(n));
    }), delete t.ifd1;
    var e = 8;
    ...
    if (this.write_uint32(4, i), Object.keys(t).forEach(function(n) {
      ...
      i = f, a.write_uint16(s, t[n].entries.length), t[n].entries.sort(function(l, y) {
        ...
        var m = s + 2 + y * 12;
        a.write_uint16(m, l.tag), a.write_uint16(m + 2, l.format), a.write_uint32(m + 4, l.count), l.is_subifd_link ? t["ifd" + l.tag] && (t["ifd" + l.tag].link_offset = m + 8) : l.data_length <= 4 ? a.output.set(a.input.subarray(l.data_offset - a.start, l.data_offset - a.start + 4), m + 8) : (a.write_uint32(m + 8, i), a.output.set(a.input.subarray(l.data_offset - a.start, l.data_offset - a.start + l.data_length), i), i += Math.ceil(l.data_length / 2) * 2);
      });
    ...
    t += 2;
    for (var a = 0; a < i; a++) {
      var n = this.read_uint16(t), s = this.read_uint16(t + 2), f = this.read_uint32(t + 4), u = this.exif_format_length(s), l = f * u, y = l <= 4 ? t + 8 : this.read_uint32(t + 8), m = false;
      ...
      this.is_subifd_link(r, n) && Array.isArray(b) && Number.isInteger(b[0]) && b[0] > 0 && (this.ifds_to_read.push({ id: n, offset: b[0] }), m = true);
      var O = { is_big_endian: this.big_endian, ifd: r, tag: n, format: s, count: f, entry_offset: t + this.start, data_length: l, data_offset: y + this.start, value: b, is_subifd_link: m };
      if (e(O) === false) {
        this.aborted = true;
        return;
      }
    ...
    for (var e = 0, i = r.length, a = false; ; ) {
      var n, s;
      ...
      if (f === 255 && u === 255) n = 255, s = 1;
        ...
        a && (n >= 208 && n <= 215 || (a = false)), n === 218 && (a = true);
      } else if (a) for (var l = e + 1; ; l++) {
      ...
      else throw I("Unexpected byte at segment start: " + d(f) + " (offset " + d(e) + ")", "EBADDATA");
      if (t({ code: n, offset: e, length: s }) === false || n === 217) break;
      e += s;
    }
    ...
    A.exports.jpeg_segments_each(r, function(s) {
      ...
      else if (Array.isArray(f)) f.filter(g).forEach(function(l) {
    ...
    A.exports.jpeg_segments_each(r, function(e) {
      if (e.code === 218) return false;
      if (e.code === 225 && e.length >= 10 && r[e.offset + 4] === 69 && r[e.offset + 5] === 120 && r[e.offset + 6] === 105 && r[e.offset + 7] === 102 && r[e.offset + 8] === 0 && r[e.offset + 9] === 0) return new c(r, e.offset + 10, e.offset + e.length).each(t), false;
    });
    ...
    return A.exports.jpeg_segments_filter(r, function(i) {
      if (!e && (i.code === 218 && (e = true), i.code === 225 && i.length >= 10 && r[i.offset + 4] === 69 && r[i.offset + 5] === 120 && r[i.offset + 6] === 105 && r[i.offset + 7] === 102 && r[i.offset + 8] === 0 && r[i.offset + 9] === 0)) {
        var a = new c(r, i.offset + 10, i.offset + i.length).filter(t);
        if (!a) return false;
        var n = new Uint8Array(10);
        return n.set(r.slice(i.offset, i.offset + 10)), n[2] = a.length + 8 >>> 8 & 255, n[3] = a.length + 8 & 255, e = true, [n, a];
      }
    });
    ...
    return A.exports.jpeg_segments_filter(r, function(a) {
      if (i++, !(i === 1 && a.code === 216) && !(i === 2 && a.code === 224) && !e) {
        ...
        }), n[s++] = 0, e = true, [n, r.subarray(a.offset, a.offset + a.length)];
      }
    });
  };
});
  ...
  return this._getUint8Array(A.blob).then(function(I) {
    ...
    try {
      ...
      if (Y.jpeg_exif_tags_each(I, function(g) {
        if (g.ifd === 0 && g.tag === 274 && Array.isArray(g.value)) return A.orientation = g.value[0] || 1, d = g.is_big_endian, h = g.data_offset, false;
      }), h) {
...
function rt(A) {
  return A.is_jpeg ? Promise.all([this._getUint8Array(A.blob), this._getUint8Array(A.out_blob)]).then(function(I) {
    var d = I[0], h = I[1];
    if (!Y.is_jpeg(d)) return Promise.resolve(A);
    var x = [];
    return Y.jpeg_segments_each(d, function(g) {
      if (g.code === 218) return false;
      x.push(g);
    }), x = x.filter(function(g) {
      return g.code === 226 ? false : g.code >= 224 && g.code < 240 || g.code === 254;
    }).map(function(g) {
      return d.slice(g.offset, g.offset + g.length);
    }), A.out_blob = new Blob([h.slice(0, 2)].concat(x).concat([h.slice(20)]), { type: "image/jpeg" }), A;
  }) : Promise.resolve(A);
}
function at(A) {
  A.before("_blob_to_image", tt), A.after("_transform", et), A.after("_create_blob", rt);
}
var it = at, nt = { assign: it };
function L(A) {
  if (!(this instanceof L)) return new L(A);
  A = A || {}, this.pica = A.pica || X({}), this.initialized = false, this.utils = W;
}
...
L.prototype.toBlob = function(A, I) {
  var d = W.assign({ max: 1 / 0 }, I), h = { blob: A, opts: d };
  return this.initialized || (this.init(), this.initialized = true), Promise.resolve(h).then(this._blob_to_image).then(this._calculate_size).then(this._transform).then(this._cleanup).then(this._create_blob).then(function(x) {
    return x.out_canvas.width = x.out_canvas.height = 0, x.out_blob;
  });
};
L.prototype.toCanvas = function(A, I) {
  var d = W.assign({ max: 1 / 0 }, I), h = { blob: A, opts: d };
  return this.initialized || (this.init(), this.initialized = true), Promise.resolve(h).then(this._blob_to_image).then(this._calculate_size).then(this._transform).then(this._cleanup).then(function(x) {
    return x.out_canvas;
  });
};

import { o as mt, n as kt, s as _t, a as xt, c as vt, b as bt, g as rt, p as wt, d as Y, Y as St, q as Lt, j as Et } from "./index.Dfumm3oK.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import { o as At } from "./ordinal.DNLwDuR1.1760966607190.js";
import { s as Tt } from "./Tableau10.B-NsZVaP.1760966607190.js";
...
function ot(t, n) {
  ...
  if (n === void 0) for (const a of t) a != null && (s < a || s === void 0 && a >= a) && (s = a);
    ...
    let a = -1;
    for (let u of t) (u = n(u, ++a, t)) != null && (s < u || s === void 0 && u >= u) && (s = u);
  }
  return s;
}
function yt(t, n) {
...
function ut({ nodes: t }) {
  for (const n of t) {
    let s = n.y0, a = s;
    for (const u of n.sourceLinks) u.y0 = s + u.width / 2, s += u.width;
    for (const u of n.targetLinks) u.y1 = a + u.width / 2, a += u.width;
  }
}
function jt() {
  ...
  function E({ nodes: e, links: f }) {
    for (const [h, r] of e.entries()) r.index = h, r.sourceLinks = [], r.targetLinks = [];
    ...
    if (c != null) for (const { sourceLinks: h, targetLinks: r } of e) h.sort(c), r.sort(c);
  }
  function L({ nodes: e }) {
  ...
  function A({ nodes: e }) {
    ...
    for (; l.size; ) {
      for (const k of l) {
        k.depth = r;
        for (const { target: v } of k.sourceLinks) h.add(v);
      }
  ...
  function N({ nodes: e }) {
    ...
    for (; l.size; ) {
      for (const k of l) {
        k.height = r;
        for (const { source: v } of k.targetLinks) h.add(v);
      }
      if (++r > f) throw new Error("circular link");
      l = h, h = /* @__PURE__ */ new Set();
    }
  ...
  function I({ nodes: e }) {
    ...
    if (o) for (const r of h) r.sort(o);
    return h;
  }
  function j(e) {
  ...
  function w({ sourceLinks: e, targetLinks: f }) {
    if (c === void 0) {
      for (const { source: { sourceLinks: l } } of f) l.sort(at);
      for (const { target: { targetLinks: l } } of e) l.sort(lt);
    }
  }
  function $(e) {
    if (c === void 0) for (const { sourceLinks: f, targetLinks: l } of e) f.sort(at), l.sort(lt);
  }
  function T(e, f) {
...
nt.prototype = gt.prototype = { constructor: nt, moveTo: function(t, n) {
  ...
  else if (m > D) if (!(Math.abs(c * p - i * o) > D) || !u) this._ += "L" + (this._x1 = t) + "," + (this._y1 = n);
  else {
...
var it = function() {
  var t = function(p, i, o, c) {
    ...
    return o;
  }, n = [1, 9], s = [1, 10], a = [1, 5, 10, 12], u = { trace: function() {
  }, yy: {}, symbols_: { error: 2, start: 3, SANKEY: 4, NEWLINE: 5, csv: 6, opt_eof: 7, record: 8, csv_tail: 9, EOF: 10, "field[source]": 11, COMMA: 12, "field[target]": 13, "field[value]": 14, field: 15, escaped: 16, non_escaped: 17, DQUOTE: 18, ESCAPED_TEXT: 19, NON_ESCAPED_TEXT: 20, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "SANKEY", 5: "NEWLINE", 10: "EOF", 11: "field[source]", 12: "COMMA", 13: "field[target]", 14: "field[value]", 18: "DQUOTE", 19: "ESCAPED_TEXT", 20: "NON_ESCAPED_TEXT" }, productions_: [0, [3, 4], [6, 2], [9, 2], [9, 0], [7, 1], [7, 0], [8, 5], [15, 1], [15, 1], [16, 3], [17, 1]], performAction: function(i, o, c, m, b, y, x) {
    var E = y.length - 1;
    switch (b) {
      case 7:
  ...
  }, table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, { 5: [1, 3] }, { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: n, 20: s }, { 1: [2, 6], 7: 11, 10: [1, 12] }, t(s, [2, 4], { 9: 13, 5: [1, 14] }), { 12: [1, 15] }, t(a, [2, 8]), t(a, [2, 9]), { 19: [1, 16] }, t(a, [2, 11]), { 1: [2, 1] }, { 1: [2, 5] }, t(s, [2, 2]), { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: n, 20: s }, { 15: 18, 16: 7, 17: 8, 18: n, 20: s }, { 18: [1, 19] }, t(s, [2, 3]), { 12: [1, 20] }, t(a, [2, 10]), { 15: 21, 16: 7, 17: 8, 18: n, 20: s }, t([1, 5, 10], [2, 7])], defaultActions: { 11: [2, 1], 12: [2, 5] }, parseError: function(i, o) {
    ...
    for (var O in this.yy) Object.prototype.hasOwnProperty.call(this.yy, O) && (M.yy[O] = this.yy[O]);
    ...
    for (var w, $, T, V, e = {}, f, l, h, r; ; ) {
      if ($ = c[c.length - 1], this.defaultActions[$] ? T = this.defaultActions[$] : ((w === null || typeof w > "u") && (w = d()), T = x[$] && x[$][w]), typeof T > "u" || !T.length || !T[0]) {
        var k = "";
        r = [];
        for (f in x[$]) this.terminals_[f] && f > N && r.push("'" + this.terminals_[f] + "'");
        S.showPosition ? k = "Parse error on line " + (L + 1) + `:
` + S.showPosition() + `
Expecting ` + r.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : k = "Parse error on line " + (L + 1) + ": Unexpected " + (w == I ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(k, { text: S.match, token: this.terminals_[w] || w, line: S.yylineno, loc: P, expected: r });
      }
      if (T[0] instanceof Array && T.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + $ + ", token: " + w);
      switch (T[0]) {
        case 1:
          c.push(w), b.push(S.yytext), y.push(S.yylloc), c.push(T[1]), w = null, A = S.yyleng, E = S.yytext, L = S.yylineno, P = S.yylloc;
          break;
        case 2:
          if (l = this.productions_[T[1]][1], e.$ = b[b.length - l], e._$ = { first_line: y[y.length - (l || 1)].first_line, last_line: y[y.length - 1].last_line, first_column: y[y.length - (l || 1)].first_column, last_column: y[y.length - 1].last_column }, C && (e._$.range = [y[y.length - (l || 1)].range[0], y[y.length - 1].range[1]]), V = this.performAction.apply(e, [E, A, L, M.yy, T[1], b, y].concat(j)), typeof V < "u") return V;
    ...
    var p = { EOF: 1, parseError: function(o, c) {
      if (this.yy.parser) this.yy.parser.parseError(o, c);
      else throw new Error(o);
    }, setInput: function(i, o) {
      return this.yy = o || this.yy || {}, this._input = i, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, input: function() {
      var i = this._input[0];
...
` + o + "^";
      ...
      for (var b = this._currentRules(), y = 0; y < b.length; y++) if (c = this._input.match(this.rules[b[y]]), c && (!o || c[0].length > o[0].length)) {
        if (o = c, m = y, this.options.backtrack_lexer) {
          if (i = this.test_match(c, b[y]), i !== false) return i;
          if (this._backtrack) {
            o = false;
            continue;
          } else return false;
      ...
      return o ? (i = this.test_match(o, b[m]), i !== false ? i : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var o = this.next();
      return o || this.lex();
    ...
    }, options: { "case-insensitive": true }, performAction: function(o, c, m, b) {
      switch (m) {
        case 0:
...
const Jt = (t) => (t = Et.sanitizeText(t, rt()), B[t] || (B[t] = new Zt(t), Q.push(B[t])), B[t]), te = () => Q, ee = () => X, ne = () => ({ nodes: Q.map((t) => ({ id: t.ID })), links: X.map((t) => ({ source: t.source.ID, target: t.target.ID, value: t.value })) }), ie = { nodesMap: B, getConfig: () => rt().sankey, getNodes: te, getLinks: ee, getGraph: ne, addLink: Kt, findOrCreateNode: Jt, getAccTitle: bt, setAccTitle: vt, getAccDescription: xt, setAccDescription: _t, getDiagramTitle: kt, setDiagramTitle: mt, clear: Xt }, pt = class st {
  static next(n) {
...
pt.count = 0;
let ft = pt;
const se = { left: Nt, right: Pt, center: Ct, justify: dt }, re = function(t, n, s, a) {
  ...
  jt().nodeId((d) => d.id).nodeWidth(10).nodePadding(10 + (L ? 15 : 0)).nodeAlign(N).extent([[0, 0], [c, m]])(A);
  const S = At(Tt);
...
}, oe = { draw: re }, le = (t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), ae = H.parse.bind(H);
H.parse = (t) => ae(le(t));
const ge = { parser: H, db: ie, renderer: oe };
export {
  ge as diagram
};

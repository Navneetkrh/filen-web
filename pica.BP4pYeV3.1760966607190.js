import { k as T, g as X } from "./index.1760966607190.js";
function N(H, Y) {
  for (var d = 0; d < Y.length; d++) {
    const I = Y[d];
    if (typeof I != "string" && !Array.isArray(I)) {
      for (const G in I) if (G !== "default" && !(G in H)) {
        const v = Object.getOwnPropertyDescriptor(I, G);
        v && Object.defineProperty(H, G, v.get ? v : { enumerable: true, get: () => I[G] });
      }
    }
  }
  ...
  return z || (z = 1, function(H, Y) {
    (function(d) {
      ...
      return (/* @__PURE__ */ function() {
          ...
          function o(a, t) {
            if (!G[a]) {
              if (!I[a]) {
                ...
                if (!t && e) return e(a, true);
                if (A) return A(a, true);
        ...
        function a(t) {
          var e = t || [], i = { js: e.indexOf("js") >= 0, wasm: e.indexOf("wasm") >= 0 };
          o.call(this, i), this.features = { js: i.js, wasm: i.wasm && this.has_wasm() }, this.use(A), this.use(n);
        }
        ...
        function o(n, a, t, e, i, h) {
          ...
          for (E = 0; E < e; E++) {
            for (m = 0, R = 0; R < i; R++) {
              for (w = h[m++], B = h[m++], y = F + w * 4 | 0, c = f = _ = p = 0; B > 0; B--) b = h[m++], p = p + b * n[y + 3] | 0, _ = _ + b * n[y + 2] | 0, f = f + b * n[y + 1] | 0, c = c + b * n[y] | 0, y = y + 4 | 0;
              a[D + 3] = v(p + 8192 >> 14), a[D + 2] = v(_ + 8192 >> 14), a[D + 1] = v(f + 8192 >> 14), a[D] = v(c + 8192 >> 14), D = D + e * 4 | 0;
            }
        ...
        I.exports = { name: "resize", fn: d("./resize"), wasm_fn: d("./resize_wasm"), wasm_src: d("./convolve_wasm_base64") };
        ...
        I.exports = function(t) {
          var e = t.src, i = t.width, h = t.height, c = t.toWidth, f = t.toHeight, _ = t.scaleX || t.toWidth / t.width, p = t.scaleY || t.toHeight / t.height, m = t.offsetX || 0, w = t.offsetY || 0, B = t.dest || new Uint8Array(c * f * 4), y = typeof t.quality > "u" ? 3 : t.quality, E = t.alpha || false, R = v(y, i, c, _, m), b = v(y, h, f, p, w), F = new Uint8Array(c * h * 4);
        ...
        I.exports = function(a, t, e, i, h) {
          ...
          for (m = 0; m < e; m++) {
            for (w = (m + 0.5) * f + h, B = Math.max(0, Math.floor(w - p)), y = Math.min(t - 1, Math.ceil(w + p)), E = y - B + 1, R = new Float32Array(E), b = new Int16Array(E), F = 0, D = B, x = 0; D <= y; D++, x++) S = c((D + 0.5 - w) * _), F += S, R[x] = S;
            for (j = 0, x = 0; x < R.length; x++) k = R[x] / F, j += k, b[x] = A(k);
            for (b[e >> 1] += A(1 - j), r = 0; r < b.length && b[r] === 0; ) r++;
            if (r < b.length) {
              for (u = b.length - 1; u > 0 && b[u] === 0; ) u--;
              if (s = B + r, l = u - r + 1, M[C++] = s, M[C++] = l, !Q) M.set(b.subarray(r, u + 1), C), C += l;
        ...
        I.exports = { name: "unsharp_mask", fn: d("./unsharp_mask"), wasm_fn: d("./unsharp_mask_wasm"), wasm_src: d("./unsharp_mask_wasm_base64") };
      }, { "./unsharp_mask": 10, "./unsharp_mask_wasm": 11, "./unsharp_mask_wasm_base64": 12 }], 10: [function(d, I, G) {
        var v = d("glur/mono16");
        function o(A, n, a) {
          for (var t = n * a, e = new Uint16Array(t), i, h, c, f, _ = 0; _ < t; _++) i = A[4 * _], h = A[4 * _ + 1], c = A[4 * _ + 2], f = i >= h && i >= c ? i : h >= c && h >= i ? h : c, e[_] = f << 8;
          return e;
        }
        I.exports = function(n, a, t, e, i, h) {
          ...
          if (!(e === 0 || i < 0.5)) {
            ...
            v(B, a, t, i);
            for (var y = e / 100 * 4096 + 0.5 | 0, E = h << 8, R = a * t, b = 0; b < R; b++) c = w[b], p = c - B[b], Math.abs(p) >= E && (f = c + (y * p + 2048 >> 12), f = f > 65280 ? 65280 : f, f = f < 0 ? 0 : f, c = c !== 0 ? c : 1, _ = (f << 12) / c | 0, m = b * 4, n[m] = n[m] * _ + 2048 >> 12, n[m + 1] = n[m + 1] * _ + 2048 >> 12, n[m + 2] = n[m + 2] * _ + 2048 >> 12);
          }
        };
        ...
        I.exports = function(o, A, n, a, t, e) {
          if (!(a === 0 || t < 0.5)) {
            t > 2 && (t = 2);
            var i = A * n, h = i * 4, c = i * 2, f = i * 2, _ = Math.max(A, n) * 4, p = 8 * 4, m = 0, w = h, B = w + c, y = B + f, E = y + f, R = E + _, b = this.__instance("unsharp_mask", h + c + f * 2 + _ + p, { exp: Math.exp }), F = new Uint32Array(o.buffer), D = new Uint32Array(this.__memory.buffer);
            D.set(F);
        ...
        o.prototype.acquire = function() {
          ...
          this.available = this.available.filter(function(a) {
            return n - a.lastUsed > A.idle ? (a.destroy(), false) : true;
        ...
        I.exports = function(a) {
          ...
          if (i < 1 || h < 1) throw new Error("Internal error in pica: target tile width/height is too small.");
          var c, f, _, p, m, w, B = [], y;
          for (p = 0; p < a.toHeight; p += h) for (_ = 0; _ < a.toWidth; _ += i) c = _ - a.destTileBorder, c < 0 && (c = 0), m = _ + i + a.destTileBorder - c, c + m >= a.toWidth && (m = a.toWidth - c), f = p - a.destTileBorder, f < 0 && (f = 0), w = p + h + a.destTileBorder - f, f + w >= a.toHeight && (w = a.toHeight - f), y = { toX: c, toY: f, toWidth: m, toHeight: w, toInnerX: _, toInnerY: p, toInnerWidth: i, toInnerHeight: h, offsetX: c / t - o(c / t), offsetY: f / e - o(f / e), scaleX: t, scaleY: e, x: o(c / t), y: o(f / e), width: A(m / t), height: A(w / e) }, B.push(y);
          return B;
        };
      }, {}], 16: [function(d, I, G) {
        function v(o) {
        ...
        I.exports.isCanvas = function(A) {
          ...
          return Promise.resolve().then(function() {
            ...
            var n = A(100, 100);
            return createImageBitmap(n, 0, 0, 100, 100, { resizeWidth: 10, resizeHeight: 10, resizeQuality: "high" }).then(function(a) {
              var t = a.width === 10;
          ...
          return new Promise(function(A, n) {
            ...
            function a(i) {
              ...
              Promise.resolve().then(function() {
                ...
                return i.postMessage(true);
              }, function() {
                return i.postMessage(false);
              });
            }
          ...
          try {
            ...
            e.data[0] = 12, e.data[1] = 23, e.data[2] = 34, e.data[3] = 255, e.data[4] = 45, e.data[5] = 56, e.data[6] = 67, e.data[7] = 255, t.putImageData(e, 0, 0), e = null, e = t.getImageData(0, 0, 2, 1), e.data[0] === 12 && e.data[1] === 23 && e.data[2] === 34 && e.data[3] === 255 && e.data[4] === 45 && e.data[5] === 56 && e.data[6] === 67 && e.data[7] === 255 && (n = true);
          } catch {
          }
          return n;
          ...
          return new Promise(function(A) {
            ...
            n.src = "data:image/jpeg;base64,", n.onload = function() {
              createImageBitmap(n, 0, 0, n.width, n.height).then(function(a) {
                a.width === n.width && a.height === n.height ? A(true) : A(false);
              }, function() {
                return A(false);
              });
            }, n.onerror = function() {
        ...
        I.exports = function() {
          ...
          onmessage = function(n) {
            ...
            if (!a.src && a.srcBitmap) {
              var t = new OffscreenCanvas(a.width, a.height), e = t.getContext("2d", { alpha: !!a.alpha });
        ...
        function c(_, p, m, w, B, y) {
          ...
          for (k = 0; k < y; k++) {
            for (x = k * B, S = k, j = 0, E = _[x], D = E * w[6], F = D, u = w[0], s = w[1], l = w[4], g = w[5], r = 0; r < B; r++) R = _[x], b = R * u + E * s + F * l + D * g, D = F, F = b, E = R, m[j] = F, j++, x++;
            for (x--, j--, S += y * (B - 1), E = _[x], D = E * w[7], F = D, R = E, u = w[2], s = w[3], r = B - 1; r >= 0; r--) b = R * u + E * s + F * l + D * g, D = F, F = b, E = R, R = _[x], p[S] = m[j] + F, x--, j--, S -= y;
          }
        }
        function f(_, p, m, w) {
          if (w) {
        ...
        typeof Object.create == "function" ? I.exports = function(o, A) {
          A && (o.super_ = A, o.prototype = Object.create(A.prototype, { constructor: { value: o, enumerable: false, writable: true, configurable: true } }));
        ...
        var v = d("object-assign"), o = d("./lib/base64decode"), A = d("./lib/wa_detect"), n = { js: true, wasm: true };
        function a(t) {
          if (!(this instanceof a)) return new a(t);
          var e = v({}, n, t || {});
          if (this.options = e, this.__cache = {}, this.__init_promise = null, this.__modules = e.modules || {}, this.__memory = null, this.__wasm = {}, this.__isLE = new Uint32Array(new Uint8Array([1, 0, 0, 0]).buffer)[0] === 1, !this.options.js && !this.options.wasm) throw new Error('mathlib: at least "js" or "wasm" should be enabled');
        }
        a.prototype.has_wasm = A, a.prototype.use = function(t) {
          ...
          if (!this.__cache[e]) {
            var f = { memoryBase: 0, memory: this.__memory, tableBase: 0, table: new WebAssembly.Table({ initial: 0, element: "anyfunc" }) };
            this.__cache[e] = new WebAssembly.Instance(this.__wasm[e], { env: v(f, h || {}) });
          }
        ...
        I.exports = function(A) {
          for (var n = A.replace(/[\r\n=]/g, ""), a = n.length, t = new Uint8Array(a * 3 >> 2), e = 0, i = 0, h = 0; h < a; h++) h % 4 === 0 && h && (t[i++] = e >> 16 & 255, t[i++] = e >> 8 & 255, t[i++] = e & 255), e = e << 6 | v.indexOf(n.charAt(h));
          var c = a % 4 * 6;
        ...
        var v;
        I.exports = function() {
          if (typeof v < "u" || (v = false, typeof WebAssembly > "u")) return v;
          try {
            ...
            return a.exports.test(4) !== 0 && (v = true), v;
          } catch {
          }
          return v;
        };
        ...
        function a() {
          try {
            ...
            if (t[5] = "de", Object.getOwnPropertyNames(t)[0] === "5") return false;
            for (var e = {}, i = 0; i < 10; i++) e["_" + String.fromCharCode(i)] = i;
            var h = Object.getOwnPropertyNames(e).map(function(f) {
              return e[f];
            });
            if (h.join("") !== "0123456789") return false;
            var c = {};
        ...
        I.exports = a() ? Object.assign : function(t, e) {
          for (var i, h = n(t), c, f = 1; f < arguments.length; f++) {
            ...
            if (v) {
              c = v(i);
              for (var p = 0; p < c.length; p++) A.call(i, c[p]) && (h[c[p]] = i[c[p]]);
            }
          }
          return h;
        };
        ...
        I.exports = function(a, t) {
          ...
          w[e] = e, o[m] = ["function(require,module,exports){var f = require(" + n(e) + ");(f.default ? f.default : f)(self);}", w];
          var B = {};
          y(m);
          function y(x) {
            B[x] = true;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        function a(r, u) {
          ...
          if (s != null) {
            var l = [], g = true, M = false, C, Q;
            try {
              for (s = s.call(r); !(g = (C = s.next()).done) && (l.push(C.value), !(u && l.length === u)); g = true) ;
            } catch (U) {
              M = true, Q = U;
            } finally {
              try {
        ...
        var e = d("object-assign"), i = d("webworkify"), h = d("./lib/mathlib"), c = d("./lib/pool"), f = d("./lib/utils"), _ = d("./lib/worker"), p = d("./lib/stepper"), m = d("./lib/tiler"), w = {}, B = false;
        try {
        ...
        var E = { tile: 1024, concurrency: y, features: ["js", "wasm", "ww"], idle: 2e3, createCanvas: function(u, s) {
          var l = document.createElement("canvas");
          return l.width = u, l.height = s, l;
        } }, R = { quality: 3, alpha: false, unsharpAmount: 0, unsharpRadius: 0, unsharpThreshold: 0 }, b = false, F = false, D = false, x = false, S = false;
        function j() {
          return { value: i(_), destroy: function() {
        ...
        function k(r) {
          ...
          this.__limit = w[u] || f.limiter(this.options.concurrency), w[u] || (w[u] = this.__limit), this.features = { js: false, wasm: false, cib: false, ww: false }, this.__workersPool = null, this.__requested_features = [], this.__mathlib = null;
        }
        k.prototype.init = function() {
          var r = this;
          if (this.__initPromise) return this.__initPromise;
          if (typeof ImageData < "u" && typeof Uint8ClampedArray < "u") try {
            new ImageData(new Uint8ClampedArray(400), 10, 10), b = true;
          } catch {
          }
          typeof ImageBitmap < "u" && (ImageBitmap.prototype && ImageBitmap.prototype.close ? F = true : this.debug("ImageBitmap does not support .close(), disabled"));
          var u = this.options.features.slice();
          if (u.indexOf("all") >= 0 && (u = ["cib", "wasm", "js", "ww"]), this.__requested_features = u, this.__mathlib = new h(u), u.indexOf("ww") >= 0 && typeof window < "u" && "Worker" in window) try {
            var s = d("webworkify")(function() {
            });
            s.terminate(), this.features.ww = true;
          ...
          }) : M = Promise.resolve(false), D = f.can_use_canvas(this.options.createCanvas);
          var C;
          F && b && u.indexOf("ww") !== -1 ? C = f.worker_offscreen_canvas_support() : C = Promise.resolve(false), C = C.then(function(U) {
            x = U;
          });
          ...
          return u.__mathCache = u.__mathCache || {}, Promise.resolve().then(function() {
            return s.features.ww ? new Promise(function(l, g) {
              ...
              var C = [];
              r.src && C.push(r.src.buffer), r.srcBitmap && C.push(r.srcBitmap), M.value.postMessage({ opts: r, features: s.__requested_features, preload: { wasm_nodule: s.__mathlib.__ } }, C);
            }) : { data: s.__mathlib.resizeAndUnsharp(r, u.__mathCache) };
          });
        }, k.prototype.__extractTileData = function(r, u, s, l, g) {
          if (this.features.ww && x && (f.isCanvas(u) || S)) return this.debug("Create tile for OffscreenCanvas"), createImageBitmap(l.srcImageBitmap || u, r.x, r.y, r.width, r.height).then(function(Q) {
            return g.srcBitmap = Q, g;
          });
          if (f.isCanvas(u)) return l.srcCtx || (l.srcCtx = u.getContext("2d", { alpha: !!s.alpha })), this.debug("Get tile pixel data"), g.src = l.srcCtx.getImageData(r.x, r.y, r.width, r.height).data, g;
          this.debug("Draw tile imageBitmap/image to temporary canvas");
          var M = this.options.createCanvas(r.width, r.height), C = M.getContext("2d", { alpha: !!s.alpha });
          ...
          var l;
          if (this.debug("Convert raw rgba tile result to ImageData"), u.bitmap) return s.toCtx.drawImage(u.bitmap, r.toX, r.toY), null;
          if (b) l = new ImageData(new Uint8ClampedArray(u.data), r.toWidth, r.toHeight);
          else if (l = s.toCtx.createImageData(r.toWidth, r.toHeight), l.data.set) l.data.set(u.data);
          ...
          var l = this, g = { srcCtx: null, srcImageBitmap: null, isImageBitmapReused: false, toCtx: null }, M = function(Q) {
            return l.__limit(function() {
              if (s.canceled) return s.cancelToken;
              var U = { width: Q.width, height: Q.height, toWidth: Q.toWidth, toHeight: Q.toHeight, scaleX: Q.scaleX, scaleY: Q.scaleY, offsetX: Q.offsetX, offsetY: Q.offsetY, quality: s.quality, alpha: s.alpha, unsharpAmount: s.unsharpAmount, unsharpRadius: s.unsharpRadius, unsharpThreshold: s.unsharpThreshold };
          ...
          return Promise.resolve().then(function() {
            if (g.toCtx = u.getContext("2d", { alpha: !!s.alpha }), f.isCanvas(r)) return null;
            if (f.isImageBitmap(r)) return g.srcImageBitmap = r, g.isImageBitmapReused = true, null;
            if (f.isImage(r)) return F ? (l.debug("Decode image via createImageBitmap"), createImageBitmap(r).then(function(C) {
              g.srcImageBitmap = C;
            }).catch(function(C) {
              return null;
            })) : null;
            ...
            var C = m({ width: s.width, height: s.height, srcTileSize: l.options.tile, toWidth: s.toWidth, toHeight: s.toHeight, destTileBorder: s.__destTileBorder }), Q = C.map(function(O) {
              return M(O);
            });
            function U(O) {
          ...
          l = e({}, l, { toWidth: Q, toHeight: U, quality: O ? l.quality : Math.min(1, l.quality) });
          var P;
          ...
          var l = this, g = u.getContext("2d", { alpha: !!s.alpha });
          return this.debug("Resize via createImageBitmap()"), createImageBitmap(r, { resizeWidth: s.toWidth, resizeHeight: s.toHeight, resizeQuality: f.cib_quality_name(s.quality) }).then(function(M) {
            if (s.canceled) return s.cancelToken;
            if (!s.unsharpAmount) return g.drawImage(M, 0, 0), M.close(), g = null, l.debug("Finished!"), u;
            l.debug("Unsharp result");
            var C = l.options.createCanvas(s.toWidth, s.toHeight), Q = C.getContext("2d", { alpha: !!s.alpha });
          ...
          var g = e({}, R);
          if (isNaN(s) ? s && (g = e(g, s)) : g = e(g, { quality: s }), g.toWidth = u.width, g.toHeight = u.height, g.width = r.naturalWidth || r.width, g.height = r.naturalHeight || r.height, u.width === 0 || u.height === 0) return Promise.reject(new Error("Invalid output size: ".concat(u.width, "x").concat(u.height)));
          g.unsharpRadius > 2 && (g.unsharpRadius = 2), g.canceled = false, g.cancelToken && (g.cancelToken = g.cancelToken.then(function(C) {
            throw g.canceled = true, C;
          }, function(C) {
            throw g.canceled = true, C;
          }));
          var M = 3;
          ...
          return u = u || "image/png", new Promise(function(l) {
            ...
            for (var g = atob(r.toDataURL(u, s).split(",")[1]), M = g.length, C = new Uint8Array(M), Q = 0; Q < M; Q++) C[Q] = g.charCodeAt(Q);
            l(new Blob([C], { type: u }));
          });
...
var L = Z();
const K = X(L), J = N({ __proto__: null, default: K }, [L]);
export {
  J as p
};

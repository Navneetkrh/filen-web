import { f as V, p as Lt } from "./flowDb-956e92f1.B-D1NVQK.1760966607190.js";
import { h as S, f as tt, G as _t } from "./graph.DhjqBz52.1760966607190.js";
import { d as x, a0 as U, l as R, g as G, Y as Et, _ as Y, $ as z, t as et, V as rt, j as at } from "./index.Dfumm3oK.1760966607190.js";
import { u as Tt, r as Nt, p as At, l as Ct, d as M } from "./layout.CqBSxywX.1760966607190.js";
import { b as N, c as nt, i as st, d as E, e as it, g as ot, f as It, a as Bt, s as Mt } from "./styles-c10674c1.BxyhZVQQ.1760966607190.js";
import { l as Dt } from "./line.jIL4itrg.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import "./index.1760966607190.js";
import "./index-3862675e.DqXX75S3.1760966607190.js";
import "./clone.BL4jgHi2.1760966607190.js";
import "./edges-e0da2a9e.pUEwyU0X.1760966607190.js";
import "./createText-2e5e7dd3.BtlU1DrF.1760966607190.js";
import "./channel.BNwECGkz.1760966607190.js";
...
var Ut = Pt("image/svg+xml"), H = { normal: Wt, vee: Vt, undirected: zt };
function $t(r) {
  H = r;
}
function Wt(r, e, t, n) {
...
var q = function(r, e, t) {
  ...
  return E(s, e).style("opacity", 1), s.each(function(i) {
    ...
    c.elem = this, c.id && o.attr("id", c.id), ot(o, c.class, (o.classed("update") ? "update " : "") + "edgePath");
...
var Q = function(r, e, t) {
  ...
  a.exit().remove(), a.enter().append("g").attr("class", "node").style("opacity", 0), a = r.selectAll("g.node"), a.each(function(i) {
    ...
    ot(c, o.class, (c.classed("update") ? "update " : "") + "node"), c.select("g.label").remove();
    var d = c.append("g").attr("class", "label"), l = J(d, o), v = t[o.shape], h = At(l.node().getBBox(), "width", "height");
    o.elem = this, o.id && c.attr("id", o.id), o.labelId && d.attr("id", o.labelId), S(o, "width") && (h.width = o.width), S(o, "height") && (h.height = o.height), h.width += o.paddingLeft + o.paddingRight, h.height += o.paddingTop + o.paddingBottom, d.attr("transform", "translate(" + (o.paddingLeft - o.paddingRight) / 2 + "," + (o.paddingTop - o.paddingBottom) / 2 + ")");
    var u = x(this);
...
function se(r, e, t, n) {
  ...
  if (a = e.y - r.y, i = r.x - e.x, c = e.x * r.y - r.x * e.y, h = a * t.x + i * t.y + c, u = a * n.x + i * n.y + c, !(h !== 0 && u !== 0 && j(h, u)) && (s = n.y - t.y, o = t.x - n.x, d = n.x * t.y - t.x * n.y, l = s * r.x + o * r.y + d, v = s * e.x + o * e.y + d, !(l !== 0 && v !== 0 && j(l, v)) && (p = a * o - s * i, p !== 0))) return y = Math.abs(p / 2), f = i * d - o * c, g = f < 0 ? (f - y) / p : (f + y) / p, f = s * c - a * d, k = f < 0 ? (f - y) / p : (f + y) / p, { x: g, y: k };
}
function j(r, e) {
  return r * e > 0;
}
function T(r, e, t) {
  ...
  for (var c = n - r.width / 2 - i, d = a - r.height / 2 - o, l = 0; l < e.length; l++) {
    var v = e[l], h = e[l < e.length - 1 ? l + 1 : 0], u = se(r, t, { x: c + v.x, y: d + v.y }, { x: c + h.x, y: d + h.y });
    u && s.push(u);
  }
...
var K = { rect: oe, ellipse: le, circle: ce, diamond: de };
function ie(r) {
  K = r;
}
function oe(r, e, t) {
...
function de(r, e, t) {
  var n = e.width * Math.SQRT2 / 2, a = e.height * Math.SQRT2 / 2, s = [{ x: 0, y: -a }, { x: -n, y: 0 }, { x: 0, y: a }, { x: n, y: 0 }], i = r.insert("polygon", ":first-child").attr("points", s.map(function(o) {
    return o.x + "," + o.y;
  }).join(" "));
...
var ue = { paddingLeft: 10, paddingRight: 10, paddingTop: 10, paddingBottom: 10, rx: 0, ry: 0, shape: "rect" }, fe = { arrowhead: "normal", curve: U };
function pe(r) {
  r.nodes().forEach(function(e) {
    var t = r.node(e);
    !S(t, "label") && !r.children(e).length && (t.label = e), S(t, "paddingX") && M(t, { paddingLeft: t.paddingX, paddingRight: t.paddingX }), S(t, "paddingY") && M(t, { paddingTop: t.paddingY, paddingBottom: t.paddingY }), S(t, "padding") && M(t, { paddingLeft: t.padding, paddingRight: t.padding, paddingTop: t.padding, paddingBottom: t.padding }), M(t, ue), tt(["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"], function(n) {
      t[n] = Number(t[n]);
...
function dt(r, e, t) {
  const n = e.width, a = e.height, s = (n + a) * 0.9, i = [{ x: s / 2, y: 0 }, { x: s, y: -s / 2 }, { x: s / 2, y: -s }, { x: 0, y: -s / 2 }], o = A(r, s, s, i);
  return t.intersect = function(c) {
    return T(t, i, c);
  }, o;
}
function ht(r, e, t) {
  const a = e.height, s = a / 4, i = e.width + 2 * s, o = [{ x: s, y: 0 }, { x: i - s, y: 0 }, { x: i, y: -a / 2 }, { x: i - s, y: -a }, { x: s, y: -a }, { x: 0, y: -a / 2 }], c = A(r, i, a, o);
  return t.intersect = function(d) {
    return T(t, o, d);
  }, c;
}
function ut(r, e, t) {
  const n = e.width, a = e.height, s = [{ x: -a / 2, y: 0 }, { x: n, y: 0 }, { x: n, y: -a }, { x: -a / 2, y: -a }, { x: 0, y: -a / 2 }], i = A(r, n, a, s);
  return t.intersect = function(o) {
    return T(t, s, o);
  }, i;
}
function ft(r, e, t) {
  const n = e.width, a = e.height, s = [{ x: -2 * a / 6, y: 0 }, { x: n - a / 6, y: 0 }, { x: n + 2 * a / 6, y: -a }, { x: a / 6, y: -a }], i = A(r, n, a, s);
  return t.intersect = function(o) {
    return T(t, s, o);
  }, i;
}
...
function vt(r, e, t) {
  const n = e.width, a = e.height, s = [{ x: -2 * a / 6, y: 0 }, { x: n + 2 * a / 6, y: 0 }, { x: n - a / 6, y: -a }, { x: a / 6, y: -a }], i = A(r, n, a, s);
  return t.intersect = function(o) {
    return T(t, s, o);
  }, i;
}
function gt(r, e, t) {
  const n = e.width, a = e.height, s = [{ x: a / 6, y: 0 }, { x: n - a / 6, y: 0 }, { x: n + 2 * a / 6, y: -a }, { x: -2 * a / 6, y: -a }], i = A(r, n, a, s);
  return t.intersect = function(o) {
    return T(t, s, o);
  }, i;
}
function yt(r, e, t) {
  const n = e.width, a = e.height, s = [{ x: 0, y: 0 }, { x: n + a / 2, y: 0 }, { x: n, y: -a / 2 }, { x: n + a / 2, y: -a }, { x: 0, y: -a }], i = A(r, n, a, s);
  return t.intersect = function(o) {
    return T(t, s, o);
  }, i;
}
...
function mt(r, e, t) {
  const n = e.width, a = e.height, s = [{ x: 0, y: 0 }, { x: n, y: 0 }, { x: n, y: -a }, { x: 0, y: -a }, { x: 0, y: 0 }, { x: -8, y: 0 }, { x: n + 8, y: 0 }, { x: n + 8, y: -a }, { x: -8, y: -a }, { x: -8, y: 0 }], i = A(r, n, a, s);
  return t.intersect = function(o) {
    return T(t, s, o);
  }, i;
}
...
const we = { addToRender: ge, addToRenderV2: ye }, bt = {}, me = function(r) {
  const e = Object.keys(r);
  for (const t of e) bt[t] = r[t];
  ...
  for (const d of c) {
    ...
    if (et(G().flowchart.htmlLabels)) {
      const g = { label: await rt(u.replace(/fa[blrs]?:fa-[\w-]+/g, (k) => `<i class='${k.replace(":", " ")}'></i>`), G()) };
    ...
    R.warn("Adding node", l.id, l.domId), e.setNode(s.db.lookUpDomId(l.id), { labelType: "svg", labelStyle: h.labelStyle, shape: f, label: p, rx: y, ry: y, class: v, style: h.style, id: s.db.lookUpDomId(l.id) });
  }
...
`), i.style === void 0 && (l.style = l.style || "stroke: #333; stroke-width: 1.5px;fill:none"), l.labelStyle = l.labelStyle.replace("color:", "fill:"))), l.id = o, l.class = c + " " + d, l.minlen = i.length || 1, e.setEdge(t.db.lookUpDomId(i.start), t.db.lookUpDomId(i.end), l, n);
  ...
  d === void 0 && (d = "TD");
  const l = s.nodeSpacing || 50, v = s.rankSpacing || 50, h = new _t({ multigraph: true, compound: true }).setGraph({ rankdir: d, nodesep: l, ranksep: v, marginx: 8, marginy: 8 }).setDefaultEdgeLabel(function() {
    return {};
  });
  let u;
  const p = n.db.getSubGraphs();
  for (let w = p.length - 1; w >= 0; w--) u = p[w], n.db.addVertex(u.id, u.title, "group", void 0, u.classes);
  ...
  for (g = p.length - 1; g >= 0; g--) {
    ...
    for (let w = 0; w < u.nodes.length; w++) R.warn("Setting subgraph", u.nodes[w], n.db.lookUpDomId(u.nodes[w]), n.db.lookUpDomId(u.id)), h.setParent(n.db.lookUpDomId(u.nodes[w]), n.db.lookUpDomId(u.id));
  }
  ...
  }), n.db.indexNodes("subGraph" + g), g = 0; g < p.length; g++) if (u = p[g], u.title !== "undefined") {
    const w = c.querySelectorAll("#" + e + ' [id="' + n.db.lookUpDomId(u.id) + '"] rect'), b = c.querySelectorAll("#" + e + ' [id="' + n.db.lookUpDomId(u.id) + '"]'), L = w[0].x.baseVal.value, m = w[0].y.baseVal.value, B = w[0].width.baseVal.value, C = x(b[0]).select(".label");
    C.attr("transform", `translate(${L + B / 2}, ${m + 14})`), C.attr("id", e + "Text");
    for (let W = 0; W < u.classes.length; W++) b[0].classList.add(u.classes[W]);
  }
  if (!s.htmlLabels) {
...
}, ke = { setConf: me, addVertices: kt, addEdges: St, getClasses: xe, draw: be }, Ue = { parser: Lt, db: V, renderer: Bt, styles: It, init: (r) => {

import { W as se, a6 as ye, d as H, e as Ee, l as S, q as we, j as De, g as he, _ as ve } from "./index.Dfumm3oK.1760966607190.js";
import { c as Ne } from "./clone.BL4jgHi2.1760966607190.js";
import { i as ke, a as Ie, b as Oe, p as Te, c as ge, d as ze } from "./edges-e0da2a9e.pUEwyU0X.1760966607190.js";
import { G as Ce } from "./graph.DhjqBz52.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import { c as Ae } from "./channel.BNwECGkz.1760966607190.js";
import { o as Re } from "./ordinal.DNLwDuR1.1760966607190.js";
import { s as Be } from "./Tableau10.B-NsZVaP.1760966607190.js";
import "./index.1760966607190.js";
import "./createText-2e5e7dd3.BtlU1DrF.1760966607190.js";
import "./line.jIL4itrg.1760966607190.js";
import "./array.BKyUJesY.1760966607190.js";
import "./path.CbwjOpE9.1760966607190.js";
import "./init.Gi6I4Gst.1760966607190.js";
var oe, le, ee = function() {
  var e = function(D, l, s, i) {
    for (s = s || {}, i = D.length; i--; s[D[i]] = l) ;
    return s;
  }, a = [1, 7], d = [1, 13], c = [1, 14], n = [1, 15], g = [1, 19], o = [1, 16], f = [1, 17], b = [1, 18], p = [8, 30], x = [8, 21, 28, 29, 30, 31, 32, 40, 44, 47], y = [1, 23], T = [1, 24], v = [8, 15, 16, 21, 28, 29, 30, 31, 32, 40, 44, 47], N = [8, 15, 16, 21, 27, 28, 29, 30, 31, 32, 40, 44, 47], E = [1, 49], L = { trace: function() {
  }, yy: {}, symbols_: { error: 2, spaceLines: 3, SPACELINE: 4, NL: 5, separator: 6, SPACE: 7, EOF: 8, start: 9, BLOCK_DIAGRAM_KEY: 10, document: 11, stop: 12, statement: 13, link: 14, LINK: 15, START_LINK: 16, LINK_LABEL: 17, STR: 18, nodeStatement: 19, columnsStatement: 20, SPACE_BLOCK: 21, blockStatement: 22, classDefStatement: 23, cssClassStatement: 24, styleStatement: 25, node: 26, SIZE: 27, COLUMNS: 28, "id-block": 29, end: 30, block: 31, NODE_ID: 32, nodeShapeNLabel: 33, dirList: 34, DIR: 35, NODE_DSTART: 36, NODE_DEND: 37, BLOCK_ARROW_START: 38, BLOCK_ARROW_END: 39, classDef: 40, CLASSDEF_ID: 41, CLASSDEF_STYLEOPTS: 42, DEFAULT: 43, class: 44, CLASSENTITY_IDS: 45, STYLECLASS: 46, style: 47, STYLE_ENTITY_IDS: 48, STYLE_DEFINITION_DATA: 49, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "SPACELINE", 5: "NL", 7: "SPACE", 8: "EOF", 10: "BLOCK_DIAGRAM_KEY", 15: "LINK", 16: "START_LINK", 17: "LINK_LABEL", 18: "STR", 21: "SPACE_BLOCK", 27: "SIZE", 28: "COLUMNS", 29: "id-block", 30: "end", 31: "block", 32: "NODE_ID", 35: "DIR", 36: "NODE_DSTART", 37: "NODE_DEND", 38: "BLOCK_ARROW_START", 39: "BLOCK_ARROW_END", 40: "classDef", 41: "CLASSDEF_ID", 42: "CLASSDEF_STYLEOPTS", 43: "DEFAULT", 44: "class", 45: "CLASSENTITY_IDS", 46: "STYLECLASS", 47: "style", 48: "STYLE_ENTITY_IDS", 49: "STYLE_DEFINITION_DATA" }, productions_: [0, [3, 1], [3, 2], [3, 2], [6, 1], [6, 1], [6, 1], [9, 3], [12, 1], [12, 1], [12, 2], [12, 2], [11, 1], [11, 2], [14, 1], [14, 4], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [19, 3], [19, 2], [19, 1], [20, 1], [22, 4], [22, 3], [26, 1], [26, 2], [34, 1], [34, 2], [33, 3], [33, 4], [23, 3], [23, 3], [24, 3], [25, 3]], performAction: function(l, s, i, u, h, t, m) {
    var r = t.length - 1;
    switch (h) {
      case 4:
      ...
      case 23:
        ...
        this.$ = [{ id: t[r - 2].id, label: t[r - 2].label, type: t[r - 2].type, directions: t[r - 2].directions }, { id: t[r - 2].id + "-" + t[r].id, start: t[r - 2].id, end: t[r].id, label: t[r - 1].label, type: "edge", directions: t[r].directions, arrowTypeEnd: F, arrowTypeStart: "arrow_open" }, { id: t[r].id, label: t[r].label, type: u.typeStr2Type(t[r].typeStr), directions: t[r].directions }];
        break;
      case 24:
    ...
    for (var I, M, z, Q, W = {}, X, B, ae, G; ; ) {
      if (M = i[i.length - 1], this.defaultActions[M] ? z = this.defaultActions[M] : ((I === null || typeof I > "u") && (I = _e()), z = m[M] && m[M][I]), typeof z > "u" || !z.length || !z[0]) {
        var $ = "";
        G = [];
        for (X in m[M]) this.terminals_[X] && X > F && G.push("'" + this.terminals_[X] + "'");
        w.showPosition ? $ = "Parse error on line " + (R + 1) + `:
` + w.showPosition() + `
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : $ = "Parse error on line " + (R + 1) + ": Unexpected " + (I == C ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError($, { text: w.match, token: this.terminals_[I] || I, line: w.yylineno, loc: J, expected: G });
      }
      if (z[0] instanceof Array && z.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + M + ", token: " + I);
      switch (z[0]) {
        case 1:
          i.push(I), h.push(w.yytext), t.push(w.yylloc), i.push(z[1]), I = null, Y = w.yyleng, r = w.yytext, R = w.yylineno, J = w.yylloc;
          break;
        case 2:
          if (B = this.productions_[z[1]][1], W.$ = h[h.length - B], W._$ = { first_line: t[t.length - (B || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (B || 1)].first_column, last_column: t[t.length - 1].last_column }, me && (W._$.range = [t[t.length - (B || 1)].range[0], t[t.length - 1].range[1]]), Q = this.performAction.apply(W, [r, Y, R, K.yy, z[1], h, t].concat(Le)), typeof Q < "u") return Q;
    ...
    var D = { EOF: 1, parseError: function(s, i) {
      if (this.yy.parser) this.yy.parser.parseError(s, i);
      else throw new Error(s);
    }, setInput: function(l, s) {
      return this.yy = s || this.yy || {}, this._input = l, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, input: function() {
      var l = this._input[0];
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: i ? (i.length === u.length ? this.yylloc.first_column : 0) + u[u.length - i.length].length - i[0].length : this.yylloc.first_column - s }, this.options.ranges && (this.yylloc.range = [h[0], h[0] + this.yyleng - s]), this.yyleng = this.yytext.length, this;
    }, more: function() {
...
` + s + "^";
      ...
      var i, u, h;
      if (this.options.backtrack_lexer && (h = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (h.yylloc.range = this.yylloc.range.slice(0))), u = l[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + l[0].length }, this.yytext += l[0], this.match += l[0], this.matches = l, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(l[0].length), this.matched += l[0], i = this.performAction.call(this, this.yy, this, s, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), i) return i;
      if (this._backtrack) {
      ...
      for (var h = this._currentRules(), t = 0; t < h.length; t++) if (i = this._input.match(this.rules[h[t]]), i && (!s || i[0].length > s[0].length)) {
        if (s = i, u = t, this.options.backtrack_lexer) {
          if (l = this.test_match(i, h[t]), l !== false) return l;
          if (this._backtrack) {
            s = false;
            continue;
          } else return false;
      ...
      return s ? (l = this.test_match(s, h[u]), l !== false ? l : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var s = this.next();
      return s || this.lex();
    ...
    }, options: {}, performAction: function(s, i, u, h) {
      switch (u) {
        case 0:
          return 10;
        case 1:
...
const Me = (e) => De.sanitizeText(e, Ke), Ye = function(e, a = "") {
  ...
  const d = V[e];
  a == null ? void 0 : a.split(pe).forEach((c) => {
    const n = c.replace(/([^;]*);/, "$1").trim();
    if (c.match(ce)) {
      const o = n.replace(ue, Fe).replace(ce, ue);
      d.textStyles.push(o);
    }
    d.styles.push(n);
  });
  ...
  for (const n of d) {
    ...
    if (n.type === "applyStyles") {
      (n == null ? void 0 : n.stylesStr) && We(n.id, n == null ? void 0 : n.stylesStr);
      continue;
    }
    if (n.type === "column-setting") a.columns = n.columns || -1;
    else if (n.type === "edge") j[n.id] ? j[n.id]++ : j[n.id] = 1, n.id = j[n.id] + "-" + n.id, ie.push(n);
    else {
...
const Ve = () => {
  S.debug("Clear called"), we(), U = { id: "root", type: "composite", children: [], columns: -1 }, O = { root: U }, re = [], V = {}, ie = [], j = {};
};
function Ue(e) {
...
const He = () => (de++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + de), qe = (e) => {
  ...
  return V;
}, rt = { getConfig: () => se().block, typeStr2Type: Ue, edgeTypeStr2Type: Xe, edgeStrToEdgeData: Ge, getLogger: st, getBlocksFlat: Je, getBlocks: Qe, getEdges: $e, setHierarchy: qe, getBlock: et, setBlock: tt, getColumns: Ze, getClasses: it, clear: Ve, generateId: He }, nt = rt, q = (e, a) => {
...
`, ot = at;
function be(e, a, d = false) {
  var c, n, g;
  const o = e;
  let f = "default";
  (((c = o == null ? void 0 : o.classes) == null ? void 0 : c.length) || 0) > 0 && (f = ((o == null ? void 0 : o.classes) || []).join(" ")), f = f + " flowchart-label";
  let b = 0, p = "", x;
  switch (o.type) {
    case "round":
      b = 5, p = "rect";
  ...
  const y = ve((o == null ? void 0 : o.styles) || []), T = o.label, v = o.size || { width: 0, height: 0, x: 0, y: 0 };
  return { labelStyle: y.labelStyle, shape: p, labelText: T, rx: b, ry: b, class: f, style: y.style, id: o.id, directions: o.directions, width: v.width, height: v.height, x: v.x, y: v.y, positioned: d, intersect: void 0, type: o.type, padding: x ?? (((g = (n = se()) == null ? void 0 : n.block) == null ? void 0 : g.padding) || 0) };
}
async function lt(e, a, d) {
  const c = be(a, d, false);
  if (c.type === "group") return;
  const n = await ge(e, c), g = n.node().getBBox(), o = d.getBlock(c.id);
...
async function ne(e, a, d, c) {
  for (const n of a) await c(e, n, d), n.children && await ne(e, n.children, d, c);
}
...
async function ht(e, a, d, c, n) {
  const g = new Ce({ multigraph: true, compound: true });
  g.setGraph({ rankdir: "TB", nodesep: 10, ranksep: 10, marginx: 8, marginy: 8 });
  for (const o of d) o.size && g.setNode(o.id, { width: o.size.width, height: o.size.height, intersect: o.intersect });
  for (const o of a) if (o.start && o.end) {
    const f = c.getBlock(o.start), b = c.getBlock(o.end);
    if ((f == null ? void 0 : f.size) && (b == null ? void 0 : b.size)) {
      const p = f.size, x = b.size, y = [{ x: p.x, y: p.y }, { x: p.x + (x.x - p.x) / 2, y: p.y + (x.y - p.y) / 2 }, { x: x.x, y: x.y }];
      await Ie(e, { v: o.start, w: o.end, name: o.id }, { ...o, arrowTypeEnd: o.arrowTypeEnd, arrowTypeStart: o.arrowTypeStart, points: y, classes: "edge-thickness-normal edge-pattern-solid flowchart-link LS-a1 LE-b1" }, void 0, "block", g, n), o.label && (await Oe(e, { ...o, label: o.label, labelStyle: "stroke: #333; stroke-width: 1.5px;fill:none;", arrowTypeEnd: o.arrowTypeEnd, arrowTypeStart: o.arrowTypeStart }), await Te({ ...o, x: y[1].x, y: y[1].y }, { originalPath: y }));
    }
  }
}
const _ = ((le = (oe = he()) == null ? void 0 : oe.block) == null ? void 0 : le.padding) || 8;
function gt(e, a) {
...
const pt = (e) => {
  ...
  for (const c of e.children) {
    ...
    S.debug("getMaxChildSize abc95 child:", c.id, "width:", n, "height:", g, "x:", o, "y:", f, c.type), c.type !== "space" && (n > a && (a = n / (e.widthInColumns || 1)), g > d && (d = g));
  }
  return { width: a, height: d };
};
function te(e, a, d = 0, c = 0) {
  var n, g, o, f, b, p, x, y, T, v, N;
  S.debug("setBlockSizes abc95 (start)", e.id, (n = e == null ? void 0 : e.size) == null ? void 0 : n.x, "block width =", e == null ? void 0 : e.size, "sieblingWidth", d), (g = e == null ? void 0 : e.size) != null && g.width || (e.size = { width: d, height: c, x: 0, y: 0 });
  let E = 0, L = 0;
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    for (const h of e.children) te(h, a);
    const A = pt(e);
    E = A.width, L = A.height, S.debug("setBlockSizes abc95 maxWidth of", e.id, ":s children is ", E, L);
    for (const h of e.children) h.size && (S.debug(`abc95 Setting size of children of ${e.id} id=${h.id} ${E} ${L} ${h.size}`), h.size.width = E * (h.widthInColumns || 1) + _ * ((h.widthInColumns || 1) - 1), h.size.height = L, h.size.x = 0, h.size.y = 0, S.debug(`abc95 updating size of ${e.id} children child:${h.id} maxWidth:${E} maxHeight:${L}`));
    for (const h of e.children) te(h, a, E, L);
    const k = e.columns || -1;
    let D = 0;
    for (const h of e.children) D += h.widthInColumns || 1;
    let l = e.children.length;
    k > 0 && k < D && (l = k), e.widthInColumns;
    const s = Math.ceil(D / l);
    let i = l * (E + _) + _, u = s * (L + _) + _;
    if (i < d) {
      S.debug(`Detected to small siebling: abc95 ${e.id} sieblingWidth ${d} sieblingHeight ${c} width ${i}`), i = d, u = c;
      const h = (d - l * _ - _) / l, t = (c - s * _ - _) / s;
      S.debug("Size indata abc88", e.id, "childWidth", h, "maxWidth", E), S.debug("Size indata abc88", e.id, "childHeight", t, "maxHeight", L), S.debug("Size indata abc88 xSize", l, "padding", _);
      for (const m of e.children) m.size && (m.size.width = h, m.size.height = t, m.size.x = 0, m.size.y = 0);
    }
    if (S.debug(`abc95 (finale calc) ${e.id} xSize ${l} ySize ${s} columns ${k}${e.children.length} width=${Math.max(i, ((f = e.size) == null ? void 0 : f.width) || 0)}`), i < (((b = e == null ? void 0 : e.size) == null ? void 0 : b.width) || 0)) {
      ...
      if (h > 0) {
        ...
        for (const m of e.children) m.size && (m.size.width = t);
      }
    }
    e.size = { width: i, height: u, x: 0, y: 0 };
  }
  S.debug("setBlockSizes abc94 (done)", e.id, (y = e == null ? void 0 : e.size) == null ? void 0 : y.x, (T = e == null ? void 0 : e.size) == null ? void 0 : T.width, (v = e == null ? void 0 : e.size) == null ? void 0 : v.y, (N = e == null ? void 0 : e.size) == null ? void 0 : N.height);
}
function xe(e, a) {
  var d, c, n, g, o, f, b, p, x, y, T, v, N, E, L, A, k;
  S.debug(`abc85 layout blocks (=>layoutBlocks) ${e.id} x: ${(d = e == null ? void 0 : e.size) == null ? void 0 : d.x} y: ${(c = e == null ? void 0 : e.size) == null ? void 0 : c.y} width: ${(n = e == null ? void 0 : e.size) == null ? void 0 : n.width}`);
  const D = e.columns || -1;
  if (S.debug("layoutBlocks columns abc95", e.id, "=>", D, e), e.children && e.children.length > 0) {
    const l = ((o = (g = e == null ? void 0 : e.children[0]) == null ? void 0 : g.size) == null ? void 0 : o.width) || 0, s = e.children.length * l + (e.children.length - 1) * _;
...
function Se(e, { minX: a, minY: d, maxX: c, maxY: n } = { minX: 0, minY: 0, maxX: 0, maxY: 0 }) {
  ...
  if (e.children) for (const g of e.children) ({ minX: a, minY: d, maxX: c, maxY: n } = Se(g, { minX: a, minY: d, maxX: c, maxY: n }));
...
function ft(e) {
  ...
  const { minX: d, minY: c, maxX: n, maxY: g } = Se(a), o = g - c, f = n - d;
...
const bt = function(e, a) {
  ...
  await ut(N, y, o);
  const E = ft(o);
  if (await dt(N, y, o), await ht(N, v, T, o, a), E) {
    const L = E, A = Math.max(1, Math.round(0.125 * (L.width / L.height))), k = L.height + A + 10, D = L.width + 10, { useMaxWidth: l } = g;
    Ee(p, k, D, !!l), S.debug("Here Bounds", E, L), p.attr("viewBox", `${L.x - 5} ${L.y - 5} ${L.width + 10} ${L.height + 10}`);
  }
  Re(Be);
}, St = { draw: xt, getClasses: bt }, Ct = { parser: Pe, db: nt, renderer: St, styles: ot };
export {
  Ct as diagram
};

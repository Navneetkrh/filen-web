import { a2 as gt, a3 as ft, a4 as mt, g as xt, l as E, d as G, Y as _t, a5 as bt, q as kt } from "./index.Dfumm3oK.1760966607190.js";
import "./percentages-BXMCSKIN.D0yBlsLW.1760966607190.js";
import { a as D } from "./arc.Budyuigr.1760966607190.js";
...
var K = function() {
  var n = function(f, i, r, c) {
    ...
    return r;
  }, t = [6, 8, 10, 11, 12, 14, 16, 17, 20, 21], e = [1, 9], a = [1, 10], s = [1, 11], h = [1, 12], l = [1, 13], p = [1, 16], y = [1, 17], g = { trace: function() {
    ...
    for (var v in this.yy) Object.prototype.hasOwnProperty.call(this.yy, v) && (w.yy[v] = this.yy[v]);
    ...
    for (var b, L, S, Z, R = {}, O, N, Y, j; ; ) {
      if (L = c[c.length - 1], this.defaultActions[L] ? S = this.defaultActions[L] : ((b === null || typeof b > "u") && (b = z()), S = $[L] && $[L][b]), typeof S > "u" || !S.length || !S[0]) {
        var J = "";
        j = [];
        for (O in $[L]) this.terminals_[O] && O > C && j.push("'" + this.terminals_[O] + "'");
        k.showPosition ? J = "Parse error on line " + (T + 1) + `:
` + k.showPosition() + `
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : J = "Parse error on line " + (T + 1) + ": Unexpected " + (b == A ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(J, { text: k.match, token: this.terminals_[b] || b, line: k.yylineno, loc: I, expected: j });
      }
      if (S[0] instanceof Array && S.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + L + ", token: " + b);
      switch (S[0]) {
        case 1:
          c.push(b), u.push(k.yytext), o.push(k.yylloc), c.push(S[1]), b = null, W = k.yyleng, x = k.yytext, T = k.yylineno, I = k.yylloc;
          break;
        case 2:
          if (N = this.productions_[S[1]][1], R.$ = u[u.length - N], R._$ = { first_line: o[o.length - (N || 1)].first_line, last_line: o[o.length - 1].last_line, first_column: o[o.length - (N || 1)].first_column, last_column: o[o.length - 1].last_column }, P && (R._$.range = [o[o.length - (N || 1)].range[0], o[o.length - 1].range[1]]), Z = this.performAction.apply(R, [x, W, T, w.yy, S[1], u, o].concat(B)), typeof Z < "u") return Z;
    ...
    var f = { EOF: 1, parseError: function(r, c) {
...
` + r + "^";
      ...
      var c, d, u;
      if (this.options.backtrack_lexer && (u = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (u.yylloc.range = this.yylloc.range.slice(0))), d = i[0].match(/(?:\r\n?|\n).*/g), d && (this.yylineno += d.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: d ? d[d.length - 1].length - d[d.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + i[0].length }, this.yytext += i[0], this.match += i[0], this.matches = i, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(i[0].length), this.matched += i[0], c = this.performAction.call(this, this.yy, this, r, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), c) return c;
      if (this._backtrack) {
        for (var o in u) this[o] = u[o];
        return false;
      }
      return false;
    }, next: function() {
      ...
      for (var u = this._currentRules(), o = 0; o < u.length; o++) if (c = this._input.match(this.rules[u[o]]), c && (!r || c[0].length > r[0].length)) {
        if (r = c, d = o, this.options.backtrack_lexer) {
          if (i = this.test_match(c, u[o]), i !== false) return i;
          if (this._backtrack) {
            r = false;
            continue;
          } else return false;
      ...
      return r ? (i = this.test_match(r, u[d]), i !== false ? i : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, lex: function() {
      var r = this.next();
      return r || this.lex();
    ...
    }, options: { "case-insensitive": true }, performAction: function(r, c, d, u) {
      switch (d) {
        case 0:
          break;
        case 1:
...
const Q = [], q = [], V = [], it = () => bt, rt = function() {
  ...
  const a = { id: st++, section: F, type: F, task: n, score: t || 0, events: e ? [e] : [] };
  V.push(a);
}, ht = function(n) {
  ...
  s.x = t.x, s.y = t.y, s.fill = t.fill, s.width = e.width, s.height = e.height, s.class = "journey-section section-type-" + t.num, s.rx = 3, s.ry = 3, U(a, s), pt(e)(t.text, a, s.x, s.y, s.width, s.height, { class: "journey-section section-type-" + t.num }, e, t.colour);
};
let et = -1;
const Mt = function(n, t, e) {
  ...
  et++;
  const h = 300 + 5 * 30;
  s.append("line").attr("id", "task" + et).attr("x1", a).attr("y1", t.y).attr("x2", a).attr("y2", h).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Tt(s, { cx: a, cy: 300 + (5 - t.score) * 30, score: t.score });
  const l = X();
  l.x = t.x, l.y = t.y, l.fill = t.fill, l.width = e.width, l.height = e.height, l.class = "task task-type-" + t.num, l.rx = 3, l.ry = 3, U(s, l), t.x + 14, pt(e)(t.task, s, l.x, l.y, l.width, l.height, { class: "task" }, e, t.colour);
}, Lt = function(n, t) {
  U(n, { x: t.startx, y: t.starty, width: t.stopx - t.startx, height: t.stopy - t.starty, fill: t.fill, class: "rect" }).lower();
}, At = function() {
  ...
  function a(s, h) {
    for (const l in h) l in h && s.attr(l, h[l]);
  }
  return function(s) {
...
function yt(n, t) {
  n.each(function() {
    ...
    for (let _ = 0; _ < a.length; _++) s = a[a.length - 1 - _], h.push(s), g.text(h.join(" ").trim()), (g.node().getComputedTextLength() > t || s === "<br>") && (h.pop(), g.text(h.join(" ").trim()), s === "<br>" ? h = [""] : h = [s], g = e.append("tspan").attr("x", 0).attr("y", p).attr("dy", l + "em").text(s));
  });
}
const Ht = function(n, t, e, a) {
  const s = e % Et - 1, h = n.append("g");
  t.section = s, h.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + s));
...
}, H = { drawRect: U, drawCircle: It, drawSection: Nt, drawText: ut, drawLabel: $t, drawTask: Mt, drawBackgroundRect: Lt, getTextObj: At, getNoteRect: X, initGraphics: Pt, drawNode: Ht, getVirtualNodeHeight: Ct }, Rt = function(n, t, e, a) {
  var s, h;
  ...
  r.forEach(function(w) {
    const v = { number: T, descr: w, section: T, width: 150, padding: 20, maxHeight: c }, I = H.getVirtualNodeHeight(m, v, l);
    E.debug("sectionHeight before draw", I), c = Math.max(c, I + 20);
  });
  let C = 0, A = 0;
  E.debug("tasks.length", f.length);
  for (const [w, v] of f.entries()) {
    const I = { number: w, descr: v, section: v.section, width: 150, padding: 20, maxHeight: d }, P = H.getVirtualNodeHeight(m, I, l);
    E.debug("taskHeight before draw", P), d = Math.max(d, P + 20), C = Math.max(C, v.events.length);
    let z = 0;
    for (let b = 0; b < v.events.length; b++) {
      const S = { descr: v.events[b], section: v.section, number: v.section, width: 150, padding: 20, maxHeight: 50 };
  ...
  E.debug("maxSectionHeight before draw", c), E.debug("maxTaskHeight before draw", d), r && r.length > 0 ? r.forEach((w) => {
    const v = f.filter((b) => b.section === w), I = { number: T, descr: w, section: T, width: 200 * Math.max(v.length, 1) - 50, padding: 20, maxHeight: c };
    E.debug("sectionNode", I);
    const P = m.append("g"), z = H.drawNode(P, I, T, l);
    E.debug("sectionNode output", z), P.attr("transform", `translate(${$}, ${o})`), x += c + 50, v.length > 0 && nt(m, v, T, $, x, d, l, C, A, c, false), $ += 200 * Math.max(v.length, 1), x = o, T++;
  }) : (W = false, nt(m, f, T, $, x, d, l, C, A, c, true));
  const B = m.node().getBBox();
  E.debug("bounds", B), i && m.append("text").text(i).attr("x", B.width / 2 - p).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), u = W ? c + d + 150 : d + 100, m.append("g").attr("class", "lineWrapper").append("line").attr("x1", p).attr("y1", u).attr("x2", B.width + 3 * p).attr("y2", u).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), _t(void 0, m, ((s = l.timeline) == null ? void 0 : s.padding) ?? 50, ((h = l.timeline) == null ? void 0 : h.useMaxWidth) ?? false);
}, nt = function(n, t, e, a, s, h, l, p, y, g, _) {
  var m;
  for (const f of t) {
    const i = { descr: f.task, section: e, number: e, width: 150, padding: 20, maxHeight: h };
    E.debug("taskNode", i);
    ...
    if (E.debug("taskHeight after draw", d), r.attr("transform", `translate(${a}, ${s})`), h = Math.max(h, d), f.events) {
      ...
      let o = h;
      s += 100, o = o + Ft(n, f.events, e, a, s, l), s -= 100, u.append("line").attr("x1", a + 190 / 2).attr("y1", s + h).attr("x2", a + 190 / 2).attr("y2", s + h + (_ ? h : g) + y + 120).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5");
    }
  ...
  s = s + 100;
  for (const y of t) {
    const g = { descr: y, section: e, number: e, width: 150, padding: 20, maxHeight: 50 };
    E.debug("eventNode", g);
  ...
  let t = "";
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], gt(n["lineColor" + e]) ? n["lineColor" + e] = ft(n["lineColor" + e], 20) : n["lineColor" + e] = mt(n["lineColor" + e], 20);
...
`, Ot = Bt, Jt = { db: St, renderer: Vt, parser: vt, styles: Ot };
export {
  Jt as diagram
};
